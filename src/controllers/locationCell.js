...
//定位
const MBLsheetLocationCell = {
  createDialog: function () {
    $("#MBLsheet-modal-dialog-mask").show();
    $("#MBLsheet-locationCell-dialog").remove();
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-locationCell-dialog",
        addclass: "MBLsheet-locationCell-dialog",
        title: locale_location.location,
        content: content,
        botton:
          '<button id="MBLsheet-locationCell-dialog-confirm" class="btn btn-primary">' +
    ...
    let $t = $("#MBLsheet-locationCell-dialog")
  ...
  init: function () {
    ...
    $(document).on(
      "click",
      "#MBLsheet-locationCell-dialog .listItem input:radio",
      function (e) {
        $("#MBLsheet-locationCell-dialog .listItem input:checkbox").prop(
          "disabled",
          true
        );
        $("#MBLsheet-locationCell-dialog .listItem .subbox label").css(
          "color",
          "#666"
        );
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-locationCell-dialog #MBLsheet-locationCell-dialog-confirm",
        function () {
          $("#MBLsheet-modal-dialog-mask").hide();
          $("#MBLsheet-locationCell-dialog").hide();

          let $radio = $(
            "#MBLsheet-locationCell-dialog .listItem input:radio:checked"
          );
  ...
  apply: function (range, type, value) {
    ...
    if (rangeArr.length == 0) {
      ...
      Store.MBLsheet_select_save = rangeArr;
      ...
      let r1 = Store.MBLsheet_select_save[0]["row"][0],
        ...
        c1 = Store.MBLsheet_select_save[0]["column"][0],
...
export default MBLsheetLocationCell;
