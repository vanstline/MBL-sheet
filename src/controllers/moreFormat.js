...
const MBLsheetMoreFormat = {
  ...
  createDialog: function (type) {
    ...
    $("#MBLsheet-moreFormat-dialog").remove();
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-moreFormat-dialog",
        addclass: "MBLsheet-moreFormat-dialog",
        title: title,
        content: content,
        botton:
          '<button id="MBLsheet-moreFormat-dialog-confirm" class="btn btn-primary">' +
    ...
    let $t = $("#MBLsheet-moreFormat-dialog")
    ...
    $("#MBLsheet-moreFormat-dialog .listbox .listItem").eq(0).addClass("on");
  },
  init: function () {
    let _this = this;
    ...
    $(document).on(
      "click",
      "#MBLsheet-moreFormat-dialog .listbox .listItem",
      function () {
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-moreFormat-dialog #MBLsheet-moreFormat-dialog-confirm",
        function () {
          $("#MBLsheet-moreFormat-dialog").hide();
          $("#MBLsheet-modal-dialog-mask").hide();

          let d = editor.deepCopyFlowData(Store.flowdata);

          let value = $(
            "#MBLsheet-moreFormat-dialog .listbox .listItem.on .value"
          ).text();
          let id = $(this)
            .parents("#MBLsheet-moreFormat-dialog")
            .find(".box")
            .attr("id");
          ...
          if (id == "morecurrency") {
            ...
            let decimal = parseInt(
              $("#MBLsheet-moreFormat-dialog .decimal input").val().trim()
            );
            ...
            let pos = $(
              "#MBLsheet-moreFormat-dialog .listbox .listItem.on input:hidden"
            ).val();
...
export default MBLsheetMoreFormat;
