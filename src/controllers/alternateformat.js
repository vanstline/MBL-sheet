...
import { MBLsheetAlternateformatHtml, modelHTML } from "./constant";
...
const alternateformat = {
  ...
  getModelBox: function (hasRowHeader, hasRowFooter) {
    ...
    $(
      "#MBLsheet-modal-dialog-slider-alternateformat #MBLsheet-alternateformat-modelList"
    ).empty();
    $(
      "#MBLsheet-modal-dialog-slider-alternateformat #MBLsheet-alternateformat-modelCustom"
    ).empty();
    ...
    let modelCustom =
      Store.MBLsheetfile[getSheetIndex(Store.currentSheetIndex)][
        "MBLsheet_alternateformat_save_modelCustom"
      ];
  ...
  init: function () {
    ...
    $("#MBLsheet-modal-dialog-slider-alternateformat").remove();
    $("body").append(MBLsheetAlternateformatHtml());
    MBLsheetsizeauto();

    //关闭
    $(
      "#MBLsheet-modal-dialog-slider-alternateformat .MBLsheet-model-close-btn"
    ).click(function () {
      $("#MBLsheet-modal-dialog-slider-alternateformat").hide();
      MBLsheetsizeauto();
    });
    ...
    $(document)
      ...
      .on(
        "focus.AFrangeInput",
        "#MBLsheet-alternateformat-range input",
        function () {
    ...
    $(document)
      ...
      .on(
        "click.AFrangeIcon",
        "#MBLsheet-alternateformat-range .fa-table",
        function () {
          $("#MBLsheet-modal-dialog-slider-alternateformat").hide();
          MBLsheetsizeauto();

          let rangeValue = $(this)
            .parents("#MBLsheet-alternateformat-range")
            .find("input")
            .val()
            .trim();
    ...
    $(document)
      ...
      .on(
        "click.AFrDCf",
        "#MBLsheet-alternateformat-rangeDialog-confirm",
        function () {
          let rangeValue = $(this)
            .parents("#MBLsheet-alternateformat-rangeDialog")
            .find("input")
            .val()
            .trim();
          $(
            "#MBLsheet-modal-dialog-slider-alternateformat #MBLsheet-alternateformat-range input"
          ).val(rangeValue);

          $(this).parents("#MBLsheet-alternateformat-rangeDialog").hide();
          $("#MBLsheet-modal-dialog-slider-alternateformat").show();
          MBLsheetsizeauto();
    ...
    $(document)
      ...
      .on(
        "click.AFrDCl",
        "#MBLsheet-alternateformat-rangeDialog-close",
        function () {
          $(this).parents("#MBLsheet-alternateformat-rangeDialog").hide();
          $("#MBLsheet-modal-dialog-slider-alternateformat").show();
          MBLsheetsizeauto();
    ...
    $(document)
      ...
      .on(
        "click.AFrDTitle",
        "#MBLsheet-alternateformat-rangeDialog .MBLsheet-modal-dialog-title-close",
        function () {
          $(this).parents("#MBLsheet-alternateformat-rangeDialog").hide();
          $("#MBLsheet-modal-dialog-slider-alternateformat").show();
          MBLsheetsizeauto();
    ...
    $(document)
      ...
      .on(
        "change.AFrowHeader",
        "#MBLsheet-alternateformat-rowHeader",
        function () {
          let hasRowHeader;
          if ($(this).is(":checked")) {
            hasRowHeader = true;
          ...
          let hasRowFooter;
          if ($("#MBLsheet-alternateformat-rowFooter").is(":checked")) {
            hasRowFooter = true;
          } else {
            hasRowFooter = false;
          }
    ...
    $(document)
      ...
      .on(
        "change.AFrowFooter",
        "#MBLsheet-alternateformat-rowFooter",
        function () {
          let hasRowHeader;
          if ($("#MBLsheet-alternateformat-rowHeader").is(":checked")) {
            hasRowHeader = true;
          } else {
            hasRowHeader = false;
          }
    ...
    $(document)
      ...
      .on(
        "click.AFmodelbox",
        "#MBLsheet-modal-dialog-slider-alternateformat .modelbox",
        function () {
          let index = $(this).index();
          let $id = $(this).parents(".cf").attr("id");

          if ($id == "MBLsheet-alternateformat-modelList") {
            _this.modelfocusIndex = index;
          } else if ($id == "MBLsheet-alternateformat-modelCustom") {
    ...
    $(document)
      ...
      .on(
        "click.AFselectColor",
        "#MBLsheet-modal-dialog-slider-alternateformat .MBLsheet-color-menu-button-indicator",
        function () {
          ...
          if (
            $(this)
              .find(".MBLsheet-icon-img")
              .hasClass("MBLsheet-icon-text-color")
          ) {
            colorType = "fc";
            ...
            $(this)
              .find(".MBLsheet-icon-img")
              .hasClass("MBLsheet-icon-cell-color")
          ) {
            colorType = "bc";
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-alternateformat-colorSelect-dialog-confirm",
        function () {
          let $parent = $(this).parents(
            "#MBLsheet-alternateformat-colorSelect-dialog"
          );
          ...
          let colorType;
          if (
            $parent.find(".MBLsheet-modal-dialog-title-text").text() ==
          ...
          if (source == "0") {
            if (colorType == "fc") {
              $(
                "#MBLsheet-alternateformat-modelToning .header .toningShow"
              ).css("color", currenColor);
              $(
                "#MBLsheet-alternateformat-modelToning .header .toningShow"
              ).data("fc", currenColor);
              $(
                "#MBLsheet-alternateformat-modelToning .header .MBLsheet-icon-text-color"
              )
                .parents(".MBLsheet-color-menu-button-indicator")
            ...
            if (colorType == "bc") {
              ...
              $(
                "#MBLsheet-alternateformat-modelToning .header .MBLsheet-icon-cell-color"
              )
                .parents(".MBLsheet-color-menu-button-indicator")
                .css("border-bottom-color", currenColor);
            }
            ...
            if (colorType == "fc") {
              $("#MBLsheet-alternateformat-modelToning .ctOne .toningShow").css(
                "color",
                currenColor
              );
              $(
                "#MBLsheet-alternateformat-modelToning .ctOne .toningShow"
              ).data("fc", currenColor);
              $(
                "#MBLsheet-alternateformat-modelToning .ctOne .MBLsheet-icon-text-color"
              )
                .parents(".MBLsheet-color-menu-button-indicator")
                .css("border-bottom-color", currenColor);
            }
            if (colorType == "bc") {
              ...
              $(
                "#MBLsheet-alternateformat-modelToning .ctOne .MBLsheet-icon-cell-color"
              )
                .parents(".MBLsheet-color-menu-button-indicator")
                .css("border-bottom-color", currenColor);
            }
            ...
            if (colorType == "fc") {
              $("#MBLsheet-alternateformat-modelToning .ctTwo .toningShow").css(
                "color",
                currenColor
              );
              $(
                "#MBLsheet-alternateformat-modelToning .ctTwo .toningShow"
              ).data("fc", currenColor);
              $(
                "#MBLsheet-alternateformat-modelToning .ctTwo .MBLsheet-icon-text-color"
              )
                .parents(".MBLsheet-color-menu-button-indicator")
                .css("border-bottom-color", currenColor);
            }
            if (colorType == "bc") {
              ...
              $(
                "#MBLsheet-alternateformat-modelToning .ctTwo .MBLsheet-icon-cell-color"
              )
                .parents(".MBLsheet-color-menu-button-indicator")
                .css("border-bottom-color", currenColor);
            }
            ...
            if (colorType == "fc") {
              $(
                "#MBLsheet-alternateformat-modelToning .footer .toningShow"
              ).css("color", currenColor);
              $(
                "#MBLsheet-alternateformat-modelToning .footer .toningShow"
              ).data("fc", currenColor);
              $(
                "#MBLsheet-alternateformat-modelToning .footer .MBLsheet-icon-text-color"
              )
                .parents(".MBLsheet-color-menu-button-indicator")
                .css("border-bottom-color", currenColor);
            }
            if (colorType == "bc") {
              ...
              $(
                "#MBLsheet-alternateformat-modelToning .footer .MBLsheet-icon-cell-color"
              )
                .parents(".MBLsheet-color-menu-button-indicator")
                .css("border-bottom-color", currenColor);
            }
          ...
          if (index < len) {
            ...
            file = Store.MBLsheetfile[getSheetIndex(Store.currentSheetIndex)];
            let modelCustom = file["MBLsheet_alternateformat_save_modelCustom"];
          ...
          if (_this.modelfocusIndex < len) {
            ...
            file["MBLsheet_alternateformat_save_modelCustom"][index - len] =
              format;
            ...
            if (server.allowUpdate) {
              server.saveParam(
                ...
                file["MBLsheet_alternateformat_save_modelCustom"],
                { k: "MBLsheet_alternateformat_save_modelCustom" }
              );
            }
          }
    ...
    $(document)
      .off("click.AFremove")
      .on("click.AFremove", "#MBLsheet-alternateformat-remove", function () {
        let dataIndex = $(this).data("index");

        let file = Store.MBLsheetfile[getSheetIndex(Store.currentSheetIndex)];

        let ruleArr = file["MBLsheet_alternateformat_save"];
  ...
  perfect: function () {
    ...
    let obj = $.extend(
      ...
      {},
      Store.MBLsheetfile[getSheetIndex(Store.currentSheetIndex)][
        "MBLsheet_alternateformat_save"
      ][existsIndex]
    );

    //应用范围
    let cellrange = obj["cellrange"];
    $("#MBLsheet-alternateformat-range input").val(
      getRangetxt(
        Store.currentSheetIndex,
    ...
    //标识 交替颜色的index
    $("#MBLsheet-alternateformat-remove").data("index", existsIndex);
  },
  checkboxChange: function (hasRowHeader, hasRowFooter) {
    if (hasRowHeader) {
      $("#MBLsheet-alternateformat-rowHeader").prop("checked", true);
      $("#MBLsheet-alternateformat-modelToning .header").show();
    } else {
      $("#MBLsheet-alternateformat-rowHeader").removeAttr("checked");
      $("#MBLsheet-alternateformat-modelToning .header").hide();
    }

    if (hasRowFooter) {
      $("#MBLsheet-alternateformat-rowFooter").prop("checked", true);
      $("#MBLsheet-alternateformat-modelToning .footer").show();
    } else {
      $("#MBLsheet-alternateformat-rowFooter").removeAttr("checked");
      $("#MBLsheet-alternateformat-modelToning .footer").hide();
    }
  ...
  modelboxOn: function () {
    ...
    //模板 foucs
    $("#MBLsheet-modal-dialog-slider-alternateformat .modelbox").removeClass(
      "on"
    );
    ...
    if (index < len) {
      $("#MBLsheet-alternateformat-modelList .modelbox")
        .eq(index)
        .addClass("on");
    } else {
      $("#MBLsheet-alternateformat-modelCustom .modelbox")
        .eq(index - len)
        .addClass("on");
    }
  ...
  modelToningColor: function () {
    ...
    //页眉
    $("#MBLsheet-alternateformat-modelToning .header .toningShow").css({
    ...
    //页脚
    $("#MBLsheet-alternateformat-modelToning .footer .toningShow").css({
  ...
  addCustomModel: function (format) {
    ...
    if (file["MBLsheet_alternateformat_save_modelCustom"] == null) {
      file["MBLsheet_alternateformat_save_modelCustom"] = [];
    }

    file["MBLsheet_alternateformat_save_modelCustom"].push(format);
  ...
  colorSelectDialog: function (currenColor, colorType, source) {
    ...
    $("#MBLsheet-alternateformat-colorSelect-dialog").remove();
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-alternateformat-colorSelect-dialog",
        addclass: "MBLsheet-alternateformat-colorSelect-dialog",
        title: title,
        content:
        ...
        botton:
          '<button id="MBLsheet-alternateformat-colorSelect-dialog-confirm" class="btn btn-primary">' +
    ...
    let $t = $("#MBLsheet-alternateformat-colorSelect-dialog")
    ...
    $("#MBLsheet-alternateformat-colorSelect-dialog")
      ...
      .spectrum({
        ...
        move: function (color) {
          ...
          $("#MBLsheet-alternateformat-colorSelect-dialog .currenColor span")
  ...
  rangeDialog: function (value) {
    $("#MBLsheet-modal-dialog-mask").hide();
    $("#MBLsheet-alternateformat-rangeDialog").remove();
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-alternateformat-rangeDialog",
        addclass: "MBLsheet-alternateformat-rangeDialog",
        ...
        content:
          ...
          '"/>',
        botton:
          '<button id="MBLsheet-alternateformat-rangeDialog-confirm" class="btn btn-primary">' +
          locale_button.confirm +
          '</button><button id="MBLsheet-alternateformat-rangeDialog-close" class="btn btn-default">' +
          locale_button.cancel +
          "</button>",
        style: "z-index:100003",
      })
    );
    let $t = $("#MBLsheet-alternateformat-rangeDialog")
        .find(".MBLsheet-modal-dialog-content")
        .css("min-width", 300)
        .end(),
      myh = $t.outerHeight(),
    ...
    let scrollLeft = $(document).scrollLeft(),
      scrollTop = $(document).scrollTop();
    $("#MBLsheet-alternateformat-rangeDialog")
      .css({
        left: (winw + scrollLeft - myw) / 2,
        top: (winh + scrollTop - myh) / 3,
      })
  ...
  update: function () {
    ...
    const alternatingColors = _locale.alternatingColors;
    //获取标识
    let dataIndex = $("#MBLsheet-alternateformat-remove").data("index");
    ...
    if (
      $(
        "#MBLsheet-modal-dialog-slider-alternateformat #MBLsheet-alternateformat-rowHeader"
      ).is(":checked")
    ) {
      hasRowHeader = true;
    } else {
    ...
    if (
      $(
        "#MBLsheet-modal-dialog-slider-alternateformat #MBLsheet-alternateformat-rowFooter"
      ).is(":checked")
    ) {
      hasRowFooter = true;
    } else {
  ...
  ref: function (historyRules, currentRules) {
    ...
    Store.MBLsheetfile[index]["MBLsheet_alternateformat_save"] = currentRules;
