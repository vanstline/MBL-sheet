...
const MBLsheetSplitColumn = {
  createDialog: function () {
    ...
    $("#MBLsheet-splitColumn-dialog").remove();
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-splitColumn-dialog",
        addclass: "MBLsheet-splitColumn-dialog",
        title: locale_splitText.splitTextTitle,
        content: content,
        botton:
          '<button id="MBLsheet-splitColumn-dialog-confirm" class="btn btn-primary">' +
    ...
    let $t = $("#MBLsheet-splitColumn-dialog")
  ...
  init: function () {
    ...
    $(document)
      ...
      .on(
        "change.SPCcheckbox",
        "#MBLsheet-splitColumn-dialog .box input[type='checkbox']",
        function () {
    ...
    $(document)
      ...
      .on(
        "keyup.SPCinptext",
        "#MBLsheet-splitColumn-dialog .box input[type='text']",
        function () {
    ...
    $(document)
      ...
      .on(
        "click.SPCconfirm",
        "#MBLsheet-splitColumn-dialog #MBLsheet-splitColumn-dialog-confirm",
        function () {
          $("#MBLsheet-modal-dialog-mask").hide();
          $("#MBLsheet-splitColumn-dialog").hide();
  ...
  update: function (r, c, dataArr) {
    ...
    let st_r = Store.MBLsheet_select_save[0].row[0],
      st_c = Store.MBLsheet_select_save[0].column[0];
  ...
  dataPreview: function (dataArr) {
    $("#MBLsheet-splitColumn-dialog #splitColumnData").empty();
    ...
    $("#MBLsheet-splitColumn-dialog #splitColumnData").append(tableHtml);
  },
  getRegStr: function () {
    let regStr = "",
      mark = 0;

    $("#MBLsheet-splitColumn-dialog .box input[type='checkbox']:checked").each(
      function (i, e) {
        let $id = $(e).attr("id");
...
export default MBLsheetSplitColumn;
