...
export function initialMatrixOperation() {
  ...
  //右键功能键
  //复制为json格式字符串，首行为标题
  $("#MBLsheet-copy-json-head").click(function (event) {
    ...
    let getdata = getdatabyselection(Store.MBLsheet_select_save[0]);
    let arr = [];
    if (getdata.length == 0) {
      return;
    }
  ...
  $("#MBLsheet-copy-json-nohead").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
    ...
    let st = Store.MBLsheet_select_save[0]["column"][0];
  ...
  //复制为一维数组
  $("#MBLsheet-copy-array1").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //复制为二维数组
  $("#MBLsheet-copy-array2").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //复制为多维数组
  $("#MBLsheet-copy-arraymore-confirm").click(function (event) {
    ...
    let row = $("#MBLsheet-copy-arraymore-row").val(),
      col = $("#MBLsheet-copy-arraymore-col").val();
  ...
  //复制为对角线
  $("#MBLsheet-copy-diagonal").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //复制为反对角线
  $("#MBLsheet-copy-antidiagonal").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //复制为对角偏移n列
  $("#MBLsheet-copy-diagonaloffset").click(function (event) {
    // Click input element, don't comfirm
    if (event.target.nodeName === "INPUT") {
      return;
    }
    ...
    let clen = getdata[0].length,
      offset = parseInt($("#MBLsheet-copy-diagonaloffset-value").val());
  ...
  //复制为布尔值
  $("#MBLsheet-copy-boolvalue").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //矩阵操作选区 翻转 上下
  $("#MBLsheet-matrix-turn-up").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //矩阵操作选区 翻转 左右
  $("#MBLsheet-matrix-turn-left").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //矩阵操作选区 翻转 顺时针
  $("#MBLsheet-matrix-turn-cw").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //矩阵操作选区 翻转 逆时针
  $("#MBLsheet-matrix-turn-anticw").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //矩阵操作选区 转置
  $("#MBLsheet-matrix-turn-trans").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //矩阵操作选区 矩阵计算
  $("#MBLsheet-matrix-cal-confirm").click(function (event) {
    // Click input element, don't comfirm
    if (
    ...
    let caltype = $("#MBLsheet-matrix-cal-type").val(),
      calvalue = parseInt($("#MBLsheet-matrix-cal-value").val());
  ...
  //矩阵操作选区 删除两端0值 按行
  $("#MBLsheet-matrix-delezero-row").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //矩阵操作选区 删除两端0值 按列
  $("#MBLsheet-matrix-delezero-column").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //矩阵操作选区 删除重复值 按行
  $("#MBLsheet-matrix-delerpt-row").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
  ...
  //矩阵操作选区 删除重复值 按列
  $("#MBLsheet-matrix-delerpt-column").click(function (event) {
    $("body .MBLsheet-cols-menu").hide();
    MBLsheetContainerFocus();
