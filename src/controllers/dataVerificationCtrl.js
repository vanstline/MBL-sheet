...
const dataVerificationCtrl = {
  ...
  createDialog: function () {
    ...
    $("#MBLsheet-dataVerification-dialog").remove();
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-dataVerification-dialog",
        addclass: "MBLsheet-dataVerification-dialog",
        title: toolbarText.dataVerification,
        content: content,
        botton: `<button id="MBLsheet-dataVerification-dialog-confirm" class="btn btn-primary">${buttonText.confirm}</button>
                        <button id="MBLsheet-dataVerification-dialog-delete" class="btn btn-default">${dvText.deleteVerification}</button>
                        <button class="btn btn-default MBLsheet-model-close-btn">${buttonText.cancel}</button>`,
        style: "z-index:100003",
      })
    );
    let $t = $("#MBLsheet-dataVerification-dialog")
    ...
    $("#MBLsheet-dataVerification-dialog")
      .css({
  ...
  init: function () {
    ...
    $(document)
      ...
      .on("click.dvRange", "#data-verification-range .fa-table", function (e) {
        $("#MBLsheet-dataVerification-dialog").hide();
    ...
    $(document)
      ...
      .on(
        "click.dvRange2",
        "#MBLsheet-dataVerification-dialog .show-box-item-dropdown .range .fa-table",
        function (e) {
          $("#MBLsheet-dataVerification-dialog").hide();
    ...
    $(document)
      ...
      .on(
        ...
        function (e) {
          ...
          if (dataSource == "0") {
            $(
              "#MBLsheet-dataVerification-dialog #data-verification-range input"
            ).val(txt);
          } else if (dataSource == "1") {
            $(
              "#MBLsheet-dataVerification-dialog .show-box-item-dropdown .range input"
            ).val(txt);
          }

          $("#MBLsheet-dataVerificationRange-dialog").hide();
          $("#MBLsheet-modal-dialog-mask").show();
          $("#MBLsheet-dataVerification-dialog").show();
    ...
    $(document)
      ...
      .on("change.typeSelect", "#data-verification-type-select", function (e) {
        $("#MBLsheet-dataVerification-dialog .show-box .show-box-item").hide();
        ...
        if (value == "dropdown") {
          $(
            "#MBLsheet-dataVerification-dialog .show-box .show-box-item-dropdown"
          ).show();
          ...
          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-dropdown .data-verification-value1"
          ).val(value1);

          $("#MBLsheet-dataVerification-dialog #data-verification-multi").prop(
            "checked",
            item.type2 ? true : false
          );
        } else if (value == "checkbox") {
          $(
            "#MBLsheet-dataVerification-dialog .show-box .show-box-item-checkbox"
          ).show();
          ...
          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-checkbox .data-verification-value1"
          ).val(value1);
          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-checkbox .data-verification-value2"
          ).val(value2);
        } else if (
          value == "number" ||
          ...
          $("#MBLsheet-dataVerification-dialog .show-box-item-number").show();
          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-number .input"
          ).hide();
          ...
          $(
            "#MBLsheet-dataVerification-dialog #data-verification-number-select"
          ).val(type2);

          if (type2 == "bw" || type2 == "nb") {
            $(
              "#MBLsheet-dataVerification-dialog .show-box-item-number .input1"
            ).show();
          } else {
            $(
              "#MBLsheet-dataVerification-dialog .show-box-item-number .input2"
            ).show();
          }

          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-number .data-verification-value1"
          ).val(value1);
          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-number .data-verification-value2"
          ).val(value2);
        } else if (value == "text_content") {
          $("#MBLsheet-dataVerification-dialog .show-box-item-text").show();
          ...
          $(
            "#MBLsheet-dataVerification-dialog #data-verification-text-select"
          ).val(type2);
          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-text .data-verification-value1"
          ).val(value1);
        } else if (value == "text_length") {
          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-textLength"
          ).show();
          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-textLength .input"
          ).hide();
          ...
          $(
            "#MBLsheet-dataVerification-dialog #data-verification-textLength-select"
          ).val(type2);

          if (type2 == "bw" || type2 == "nb") {
            $(
              "#MBLsheet-dataVerification-dialog .show-box-item-textLength .input1"
            ).show();
          } else {
            $(
              "#MBLsheet-dataVerification-dialog .show-box-item-textLength .input2"
            ).show();
          }

          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-textLength .data-verification-value1"
          ).val(value1);
          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-textLength .data-verification-value2"
          ).val(value2);
        } else if (value == "date") {
          $("#MBLsheet-dataVerification-dialog .show-box-item-date").show();
          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-date .input"
          ).hide();
          ...
          $(
            "#MBLsheet-dataVerification-dialog #data-verification-date-select"
          ).val(type2);

          if (type2 == "bw" || type2 == "nb") {
            $(
              "#MBLsheet-dataVerification-dialog .show-box-item-date .input1"
            ).show();
          } else {
            $(
              "#MBLsheet-dataVerification-dialog .show-box-item-date .input2"
            ).show();
          }

          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-date .data-verification-value1"
          ).val(value1);
          $(
            "#MBLsheet-dataVerification-dialog .show-box-item-date .data-verification-value2"
          ).val(value2);
        } else if (value == "validity") {
          $(
            "#MBLsheet-dataVerification-dialog .show-box .show-box-item-validity"
          ).show();
          ...
          $(
            "#MBLsheet-dataVerification-dialog #data-verification-validity-select"
          ).val(type2);
        }
      });
    ...
    $(document)
      ...
      .on("change.hintShow", "#data-verification-hint-show", function (e) {
        if (this.checked) {
          $(
            "#MBLsheet-dataVerification-dialog .data-verification-hint-text"
          ).show();
        } else {
          $(
            "#MBLsheet-dataVerification-dialog .data-verification-hint-text"
    ...
    $(document)
      ...
      .on(
        "click.dvSaveConfirm",
        "#MBLsheet-dataVerification-dialog-confirm",
        function (e) {
          let rangeTxt = $(
            "#MBLsheet-dataVerification-dialog #data-verification-range input"
          )
          ...
          let type = $(
            "#MBLsheet-dataVerification-dialog #data-verification-type-select"
          ).val();
          let type2 = null,
            value1 = "",
            value2 = "";
          ...
          if (type == "dropdown") {
            ...
            type2 = $(
              "#MBLsheet-dataVerification-dialog #data-verification-multi"
            ).is(":checked");
            ...
            value1 = $(
              "#MBLsheet-dataVerification-dialog .show-box-item-number .input:visible .data-verification-value1"
            )
              .val()
              .trim();
            ...
            if (type2 == "bw" || type2 == "nb") {
              value2 = $(
                "#MBLsheet-dataVerification-dialog .show-box-item-number .input:visible .data-verification-value2"
              )
                .val()
                .trim();
            ...
            value1 = $(
              "#MBLsheet-dataVerification-dialog .show-box-item-textLength .input:visible .data-verification-value1"
            )
              .val()
              .trim();
            ...
            if (type2 == "bw" || type2 == "nb") {
              value2 = $(
                "#MBLsheet-dataVerification-dialog .show-box-item-textLength .input:visible .data-verification-value2"
              )
                .val()
                .trim();
            ...
            value1 = $(
              "#MBLsheet-dataVerification-dialog .show-box-item-date .input:visible .data-verification-value1"
            )
              .val()
              .trim();
            ...
            if (type2 == "bw" || type2 == "nb") {
              value2 = $(
                "#MBLsheet-dataVerification-dialog .show-box-item-date .input:visible .data-verification-value2"
              )
                .val()
                .trim();
          ...
          let remote = $(
            "#MBLsheet-dataVerification-dialog #data-verification-remote"
          ).is(":checked");
          let prohibitInput = $(
            "#MBLsheet-dataVerification-dialog #data-verification-prohibitInput"
          ).is(":checked");
          let hintShow = $(
            "#MBLsheet-dataVerification-dialog #data-verification-hint-show"
          ).is(":checked");
          let hintText = "";

          if (hintShow) {
            hintText = $(
              "#MBLsheet-dataVerification-dialog .data-verification-hint-text input"
            )
              .val()
              .trim();
          }
    ...
    $(document)
      ...
      .on(
        "click.delete",
        "#MBLsheet-dataVerification-dialog-delete",
        function (e) {
          let rangeTxt = $(
            "#MBLsheet-dataVerification-dialog #data-verification-range input"
          )
    ...
    $(document).on(
      "click",
      "#MBLsheet-info .MBLsheet-modal-dialog-title-close, #MBLsheet-info .MBLsheet-model-close-btn",
      function (e) {
        $(this).parents("#MBLsheet-info").hide();

        if ($("#MBLsheet-dataVerification-dialog").is(":visible")) {
          $("#MBLsheet-modal-dialog-mask").show();
        }
        e.stopPropagation();
      }
  ...
  dataAllocation: function () {
    ...
    $("#MBLsheet-dataVerification-dialog #data-verification-range input").val(
      rangeTxt
    );
    ...
    //验证条件
    $("#MBLsheet-dataVerification-dialog #data-verification-type-select").val(
      item.type
    );
    $("#MBLsheet-dataVerification-dialog .show-box .show-box-item").hide();
    ...
    if (item.type == "dropdown") {
      ...
      $("#MBLsheet-dataVerification-dialog .show-box-item-text").show();
      $("#MBLsheet-dataVerification-dialog #data-verification-text-select").val(
        item.type2
      );
      $(
        "#MBLsheet-dataVerification-dialog .show-box-item-text .data-verification-value1"
      ...
      $("#MBLsheet-dataVerification-dialog .show-box-item-textLength").show();
      $(
        "#MBLsheet-dataVerification-dialog #data-verification-textLength-select"
      ).val(item.type2);
      $(
      ...
      $("#MBLsheet-dataVerification-dialog .show-box-item-date").show();
      $("#MBLsheet-dataVerification-dialog #data-verification-date-select").val(
        item.type2
      );
      $("#MBLsheet-dataVerification-dialog .show-box-item-date .input").hide();
    ...
    //自动远程获取选项
    $("#MBLsheet-dataVerification-dialog #data-verification-remote").prop(
      "checked",
      item.remote
    );
    ...
    //选中单元格时显示提示语
    $("#MBLsheet-dataVerification-dialog #data-verification-hint-show").prop(
      "checked",
      item.hintShow
    );
  ...
  rangeDialog: function (dataSource, txt) {
    ...
    $("#MBLsheet-modal-dialog-mask").hide();
    $("#MBLsheet-dataVerificationRange-dialog").remove();

    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-dataVerificationRange-dialog",
        addclass: "MBLsheet-dataVerificationRange-dialog",
        title: dvText.selectCellRange,
        content: `<input readonly="readonly" placeholder="${dvText.selectCellRange2}" value="${txt}"/>`,
        botton: `<button id="MBLsheet-dataVerificationRange-dialog-confirm" class="btn btn-primary" data-source="${dataSource}">${buttonText.confirm}</button>
                        <button id="MBLsheet-dataVerificationRange-dialog-close" class="btn btn-default">${buttonText.close}</button>`,
        style: "z-index:100003",
      })
    );
    let $t = $("#MBLsheet-dataVerificationRange-dialog")
        .find(".MBLsheet-modal-dialog-content")
        .css("min-width", 300)
        .end(),
      myh = $t.outerHeight(),
    ...
    let scrollLeft = $(document).scrollLeft(),
      scrollTop = $(document).scrollTop();
    $("#MBLsheet-dataVerificationRange-dialog")
      .css({
        left: (winw + scrollLeft - myw) / 2,
        top: (winh + scrollTop - myh) / 3,
      })
  ...
  cellFocus: function (r, c, clickMode) {
    $("#MBLsheet-dataVerification-dropdown-btn").hide();
    ...
    if (item.type == "dropdown" && !Store.flowdata?.[r]?.[c]?.disabled) {
      ...
      if ($("#MBLsheet-dataVerification-dropdown-List").is(":visible")) {
        let dataIndex = $("#MBLsheet-dataVerification-dropdown-List").prop(
          "data-index"
        );
  ...
  dropdownListShow: function () {
    ...
    let currentWinH = $("#MBLsheet-cell-main")[0].scrollHeight;
  ...
  getDropdownList: function (txt) {
    ...
    if (formula.iscelldata(txt)) {
      ...
      let d = Store.MBLsheetfile[getSheetIndex(range.sheetIndex)].data;
  ...
  ref: function (historyDataVerification, currentDataVerification, sheetIndex) {
    ...
    Store.MBLsheetfile[getSheetIndex(sheetIndex)].dataVerification =
      currentDataVerification;
