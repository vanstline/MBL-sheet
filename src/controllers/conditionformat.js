...
import { modelHTML, MBLsheet_CFiconsImg } from "./constant";
...
const conditionformat = {
  fileClone: [],
  editorRule: null, //{"sheetIndex": sheetIndex,"itemIndex": itemIndex,"data": MBLsheetfile[sheetIndex].MBLsheet_conditionformat_save[itemIndex]}
  ruleTypeHtml: function () {
    const conditionformat_Text = locale().conditionformat;

    return `<div class="ruleTypeBox">
                    <div class="ruleTypeItem">
                        <span class="icon iconfont MBLsheet-iconfont-youjiantou"></span>
  ...
  textCellColorHtml: function () {
    ...
    return `<div id="textCellColor">
                    <div class="colorbox">
                        ...
                        <input id="textcolorshow" data-tips="${conditionformat_Text.textColor}" data-func="background" class="MBLsheet-conditionformat-config-color" type="text" value="#9c0006" style="display: none;">
                    </div>
                    <div class="colorbox">
                        <input id="checkCellColor" type="checkbox" checked="checked">
                        <label for="checkCellColor">${conditionformat_Text.cellColor}：</label>
                        <input id="cellcolorshow" data-tips="${conditionformat_Text.cellColor}" data-func="background" class="MBLsheet-conditionformat-config-color" type="text" value="#ffc7ce" style="display: none;">
                    </div>
                </div>`;
  },
  selectRange: [],
  ...
  init: function () {
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-administerRule-dialog .chooseSheet",
        function () {
          let index = $(
            "#MBLsheet-administerRule-dialog .chooseSheet option:selected"
          ).val();
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-administerRule-dialog .ruleList .listBox .item",
        function () {
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-administerRule-dialog-confirm",
        function () {
          ...
          for (let c = 0; c < fileClone.length; c++) {
            ...
            Store.MBLsheetfile[getSheetIndex(sheetIndex)][
          ...
          $("#MBLsheet-administerRule-dialog").hide();

          //发送给后台
          if (server.allowUpdate) {
            let files = $.extend(true, [], Store.MBLsheetfile);
            for (let i = 0; i < files.length; i++) {
              server.saveParam(
                "all",
                files[i]["index"],
                files[i]["MBLsheet_conditionformat_save"],
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-administerRule-dialog-close",
        function () {
          $("#MBLsheet-modal-dialog-mask").hide();
          $("#MBLsheet-administerRule-dialog").hide();
          _this.fileClone = [];
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-administerRule-dialog .item .fa-table",
        function () {
          $(this).parents("#MBLsheet-administerRule-dialog").hide();

          let sheetIndex = $(
            "#MBLsheet-administerRule-dialog .chooseSheet select option:selected"
          ).val();
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-multiRange-dialog-confirm",
        function () {
          $(this).parents("#MBLsheet-multiRange-dialog").hide();

          let dataItem = $(this).attr("data-item");
          let v = $(this)
            .parents("#MBLsheet-multiRange-dialog")
            .find("input")
            .val();
          $(
            "#MBLsheet-administerRule-dialog .item[data-item=" +
              dataItem +
              "] input"
          ).val(v);
          ...
          $("#MBLsheet-administerRule-dialog").show();
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-multiRange-dialog-close",
        function () {
          $(this).parents("#MBLsheet-multiRange-dialog").hide();
          $("#MBLsheet-modal-dialog-mask").show();
          $("#MBLsheet-administerRule-dialog").show();
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-newConditionRule-dialog-confirm",
        function () {
          if (!checkProtectionFormatCells(Store.currentSheetIndex)) {
            return;
          }
          ...
          let index = $(
            "#MBLsheet-newConditionRule-dialog .ruleTypeItem.on"
          ).index();
          let type1 = $(
            "#MBLsheet-newConditionRule-dialog #type1 option:selected"
          ).val();
          let type2 = $(
            "#MBLsheet-newConditionRule-dialog ." +
              type1 +
          ...
          if (index == 0) {
            if (type1 == "dataBar") {
              //数据条
              let color = $(this)
                .parents("#MBLsheet-newConditionRule-dialog")
                .find(".dataBarBox .MBLsheet-conditionformat-config-color")
                .spectrum("get")
                .toHexString();
              ...
              rule = {
                type: "dataBar",
                cellrange: $.extend(true, [], Store.MBLsheet_select_save),
                format: format,
              };
              ...
              let maxcolor = $(this)
                .parents("#MBLsheet-newConditionRule-dialog")
                .find(
                  ".colorGradationBox .maxVal .MBLsheet-conditionformat-config-color"
                )
                .spectrum("get")
                .toRgbString();
              let midcolor = $(this)
                .parents("#MBLsheet-newConditionRule-dialog")
                .find(
                  ".colorGradationBox .midVal .MBLsheet-conditionformat-config-color"
                )
                .spectrum("get")
                .toRgbString();
              let mincolor = $(this)
                .parents("#MBLsheet-newConditionRule-dialog")
                .find(
                  ".colorGradationBox .minVal .MBLsheet-conditionformat-config-color"
                )
                .spectrum("get")
                .toRgbString();
            ...
            if (index == 1) {
              if (type1 == "number") {
                ...
                if (type2 == "betweenness") {
                  let v1 = $(
                    "#MBLsheet-newConditionRule-dialog #conditionVal input"
                  )
                    .val()
                    .trim();
                  let v2 = $(
                    "#MBLsheet-newConditionRule-dialog #conditionVal2 input"
                  )
                    .val()
                    .trim();
                ...
                //条件值
                let v = $(
                  "#MBLsheet-newConditionRule-dialog #daterange-btn"
                ).val();
              ...
              if (type1 == "top") {
                if (
                  $("#MBLsheet-newConditionRule-dialog #isPercent").is(
                    ":selected"
                  )
                ) {
                  conditionName = "top10%";
              ...
              //条件值
              let v = $("#MBLsheet-newConditionRule-dialog #conditionVal input")
                .val()
                .trim();
              ...
              //条件值
              let v = $(
                "#MBLsheet-newConditionRule-dialog #formulaConditionVal input"
              )
                .val()
                .trim();
            ...
            let textcolor;
            if (
              $("#MBLsheet-newConditionRule-dialog #checkTextColor").is(
                ":checked"
              )
            ) {
              textcolor = $("#MBLsheet-newConditionRule-dialog #textcolorshow")
                .spectrum("get")
                .toHexString();
            } else {
              textcolor = null;
            ...
            let cellcolor;
            if (
              $("#MBLsheet-newConditionRule-dialog #checkCellColor").is(
                ":checked"
              )
            ) {
              cellcolor = $("#MBLsheet-newConditionRule-dialog #cellcolorshow")
                .spectrum("get")
                .toHexString();
            } else {
              cellcolor = null;
          ...
          $("#MBLsheet-newConditionRule-dialog").hide();
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-newConditionRule-dialog-close",
        function () {
          //新建规则的入口
          let source = $(this).attr("data-source");
          if (source == 0) {
    ...
    $(document)
      ...
      .on("click.CFeditorConditionRule", "#editorConditionRule", function () {
        ...
        let itemIndex = $(
          "#MBLsheet-administerRule-dialog .ruleList .listBox .item.on"
        ).attr("data-item");
        let rule = {
    ...
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-editorConditionRule-dialog-confirm",
        function () {
          let index = $(
            "#MBLsheet-editorConditionRule-dialog .ruleTypeItem.on"
          ).index();
          let type1 = $(
            "#MBLsheet-editorConditionRule-dialog #type1 option:selected"
          ).val();
          let type2 = $(
            "#MBLsheet-editorConditionRule-dialog ." +
              type1 +
              "Box #type2 option:selected"
          ).val();
          ...
          if (index == 0) {
            if (type1 == "dataBar") {
              //数据条
              let color = $(this)
                .parents("#MBLsheet-editorConditionRule-dialog")
                .find(".dataBarBox .MBLsheet-conditionformat-config-color")
                .spectrum("get")
                .toHexString();
            ...
            if (index == 1) {
              if (type1 == "number") {
                ...
                if (type2 == "betweenness") {
                  let v1 = $(
                    "#MBLsheet-editorConditionRule-dialog #conditionVal input"
                  )
                    .val()
                    .trim();
                  let v2 = $(
                    "#MBLsheet-editorConditionRule-dialog #conditionVal2 input"
                  )
                    .val()
                    .trim();
                ...
                //条件值
                let v = $(
                  "#MBLsheet-editorConditionRule-dialog #daterange-btn"
                ).val();
              ...
              if (type1 == "top") {
                if (
                  $("#MBLsheet-editorConditionRule-dialog #isPercent").is(
                    ":selected"
                  )
                ) {
                  conditionName = "top10%";
              ...
              //条件值
              let v = $(
                "#MBLsheet-editorConditionRule-dialog #formulaConditionVal input"
              )
                .val()
                .trim();
              console.log(v);
            ...
            let textcolor;
            if (
              $("#MBLsheet-editorConditionRule-dialog #checkTextColor").is(
                ":checked"
              )
            ) {
              textcolor = $(
                "#MBLsheet-editorConditionRule-dialog #textcolorshow"
              )
                .spectrum("get")
                .toHexString();
            } else {
            ...
            let cellcolor;
            if (
              $("#MBLsheet-editorConditionRule-dialog #checkCellColor").is(
                ":checked"
              )
            ) {
              cellcolor = $(
                "#MBLsheet-editorConditionRule-dialog #cellcolorshow"
              )
                .spectrum("get")
                .toHexString();
            } else {
          ...
          //编辑规则隐藏，管理规则显示
          $("#MBLsheet-editorConditionRule-dialog").hide();
          _this.administerRuleDialog();
        }
      );
    $(document)
      ...
      .on(
        ...
        "#MBLsheet-editorConditionRule-dialog-close",
        function () {
          //编辑规则隐藏，管理规则显示
          $("#MBLsheet-editorConditionRule-dialog").hide();
          $("#MBLsheet-administerRule-dialog").show();
    ...
    $(document)
      ...
      .on(
        ...
        ".MBLsheet-newEditorRule-dialog .ruleTypeItem",
        function () {
          $(this).addClass("on").siblings().removeClass("on");

          let index = $(this).index();
          $(this)
            .parents(".MBLsheet-newEditorRule-dialog")
            .find(".ruleExplainBox")
    ...
    $(document)
      ...
      .on(
        ...
        ".MBLsheet-newEditorRule-dialog #type1",
        function () {
          ...
          if (optionVal == "date") {
            _this.daterangeInit(
              $(this).parents(".MBLsheet-newEditorRule-dialog").attr("id")
            );
          }
        }
      );
    $(document)
      ...
      .on(
        ...
        ".MBLsheet-newEditorRule-dialog #type2",
        function () {
          let type1 = $(this)
            .parents(".MBLsheet-newEditorRule-dialog")
    ...
    $(document)
      ...
      .on(
        ...
        ".MBLsheet-newEditorRule-dialog .iconsBox .showbox",
        function () {
    ...
    $(document)
      ...
      .on(
        "click.CFiconsLi",
        ".MBLsheet-newEditorRule-dialog .iconsBox li",
        function () {
    ...
    $(document)
      ...
      .on(
        "click.CFdefault",
        "#MBLsheet-conditionformat-dialog-confirm",
        function () {
          if (!checkProtectionFormatCells(Store.currentSheetIndex)) {
            return;
          }
          ...
          //条件名称
          let conditionName = $("#MBLsheet-conditionformat-dialog .box").attr(
            "data-itemvalue"
          );
          ...
          if (
            ...
            let v = $("#MBLsheet-conditionformat-dialog #conditionVal")
              .val()
              .trim();
            ...
            //介于
            let v1 = $("#MBLsheet-conditionformat-dialog #conditionVal")
              .val()
              .trim();
            let v2 = $("#MBLsheet-conditionformat-dialog #conditionVal2")
              .val()
              .trim();
            ...
            //日期
            let v = $("#MBLsheet-conditionformat-dialog #daterange-btn").val();
            ...
            conditionValue.push(
              $(
                "#MBLsheet-conditionformat-dialog #conditionVal option:selected"
              ).val()
            );
          } else if (
            conditionName == "top10" ||
          ...
          //隐藏一些dom
          $("#MBLsheet-modal-dialog-mask").hide();
          $("#MBLsheet-conditionformat-dialog").hide();
    ...
    $(document)
      .off("click.CFicons")
      .on("click.CFicons", "#MBLsheet-CFicons-dialog .item", function () {
        $("#MBLsheet-modal-dialog-mask").hide();
        $("#MBLsheet-CFicons-dialog").hide();
    ...
    $(document).on("click", ".range .fa-table", function () {
      let id = $(this).parents(".MBLsheet-modal-dialog").attr("id");
      $("#" + id).hide();
      //入口
      let source;

      if (id == "MBLsheet-conditionformat-dialog") {
      ...
      } else if (id == "MBLsheet-newConditionRule-dialog") {
      ...
      } else if (id == "MBLsheet-editorConditionRule-dialog") {
        let $id = $(this).parents(".range").attr("id");
    ...
    $(document).on(
      "click",
      "#MBLsheet-singleRange-dialog-confirm",
      function () {
        $("#MBLsheet-modal-dialog-mask").show();
        $(this).parents("#MBLsheet-singleRange-dialog").hide();

        let source = $(this).attr("data-source");
        let v = $(this)
          .parents("#MBLsheet-singleRange-dialog")
          .find("input")
          .val();

        if (source == "0_1") {
          $("#MBLsheet-conditionformat-dialog").show();
          $("#MBLsheet-conditionformat-dialog #conditionVal").val(v);
        } else if (source == "0_2") {
          $("#MBLsheet-conditionformat-dialog").show();
          $("#MBLsheet-conditionformat-dialog #conditionVal2").val(v);
        } else if (source == "1_0") {
          $("#MBLsheet-newConditionRule-dialog").show();
          $("#MBLsheet-newConditionRule-dialog #formulaConditionVal input").val(
            v
          );
        } else if (source == "1_1") {
          $("#MBLsheet-newConditionRule-dialog").show();
          $("#MBLsheet-newConditionRule-dialog #conditionVal input").val(v);
        } else if (source == "1_2") {
          $("#MBLsheet-newConditionRule-dialog").show();
          $("#MBLsheet-newConditionRule-dialog #conditionVal2 input").val(v);
        } else if (source == "2_0") {
          $("#MBLsheet-editorConditionRule-dialog").show();
          $(
            "#MBLsheet-editorConditionRule-dialog #formulaConditionVal input"
          ).val(v);
        } else if (source == "2_1") {
          $("#MBLsheet-editorConditionRule-dialog").show();
          $("#MBLsheet-editorConditionRule-dialog #conditionVal input").val(v);
        } else if (source == "2_2") {
          $("#MBLsheet-editorConditionRule-dialog").show();
          $("#MBLsheet-editorConditionRule-dialog #conditionVal2 input").val(v);
        }
    ...
    $(document).on("click", "#MBLsheet-singleRange-dialog-close", function () {
      $("#MBLsheet-modal-dialog-mask").show();
      $(this).parents("#MBLsheet-singleRange-dialog").hide();
    ...
    // 弹出层右上角关闭按钮
    $(document).on("click", ".MBLsheet-modal-dialog-title-close", function () {
      let id = $(this).parents(".MBLsheet-modal-dialog").attr("id");

      //新建规则弹出层
      if (id == "MBLsheet-newConditionRule-dialog") {
        let source = $("#" + id)
          .find("#MBLsheet-newConditionRule-dialog-close")
          .attr("data-source");
        //新建规则入口
        if (source == 1) {
          $("#MBLsheet-administerRule-dialog").show();
      ...
      //编辑规则弹出层
      if (id == "MBLsheet-editorConditionRule-dialog") {
        $("#MBLsheet-administerRule-dialog").show();
      }

      //选择单元格弹出层
      if (id == "MBLsheet-singleRange-dialog") {
        $("#MBLsheet-modal-dialog-mask").show();

        let source = $(this)
          .parents("#MBLsheet-singleRange-dialog")
          .find("#MBLsheet-singleRange-dialog-confirm")
          .attr("data-source");
        if (source == "0_1" || source == "0_2") {
          $("#MBLsheet-conditionformat-dialog").show();
      ...
      //选择应用范围弹出层
      if (id == "MBLsheet-multiRange-dialog") {
        $("#MBLsheet-modal-dialog-mask").show();
      ...
      //提示框
      if (id == "MBLsheet-conditionformat-info-dialog") {
        $("#MBLsheet-modal-dialog-mask").show();
      }
    });
    ...
    $(document).on(
      "click",
      "#MBLsheet-conditionformat-info-dialog-close",
      function () {
        $(this).parents("#MBLsheet-conditionformat-info-dialog").hide();
      }
    );
  },
  singleRangeDialog: function (source, value) {
    $("#MBLsheet-modal-dialog-mask").hide();
    $("#MBLsheet-singleRange-dialog").remove();

    const conditionformat_Text = locale().conditionformat;

    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-singleRange-dialog",
        addclass: "MBLsheet-singleRange-dialog",
        ...
        botton: `<button id="MBLsheet-singleRange-dialog-confirm" class="btn btn-primary" data-source="${source}">${conditionformat_Text.confirm}</button>
                        <button id="MBLsheet-singleRange-dialog-close" class="btn btn-default" data-source="${source}">${conditionformat_Text.cancel}</button>`,
        style: "z-index:100003",
      })
    );
    let $t = $("#MBLsheet-singleRange-dialog")
  ...
  multiRangeDialog: function (dataItem, value) {
    ...
    $("#MBLsheet-modal-dialog-mask").hide();
    $("#MBLsheet-multiRange-dialog").remove();

    const conditionformat_Text = locale().conditionformat;

    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-multiRange-dialog",
        addclass: "MBLsheet-multiRange-dialog",
        ...
        botton: `<button id="MBLsheet-multiRange-dialog-confirm" class="btn btn-primary" data-item="${dataItem}">${conditionformat_Text.confirm}</button>
                        <button id="MBLsheet-multiRange-dialog-close" class="btn btn-default">${conditionformat_Text.cancel}</button>`,
        style: "z-index:100003",
      })
    );
    let $t = $("#MBLsheet-multiRange-dialog")
        .find(".MBLsheet-modal-dialog-content")
        .css("min-width", 300)
        .end(),
      myh = $t.outerHeight(),
  ...
  colorSelectInit: function () {
    ...
    $(".MBLsheet-conditionformat-config-color").spectrum({
      showPalette: true,
  ...
  conditionformatDialog: function (title, content) {
    ...
    $("#MBLsheet-modal-dialog-mask").show();
    $("#MBLsheet-conditionformat-dialog").remove();

    const conditionformat_Text = locale().conditionformat;

    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-conditionformat-dialog",
        addclass: "MBLsheet-conditionformat-dialog",
        title: title,
        content: content,
        botton: `<button id="MBLsheet-conditionformat-dialog-confirm" class="btn btn-primary">${conditionformat_Text.confirm}</button>
                        <button class="btn btn-default MBLsheet-model-close-btn">${conditionformat_Text.cancel}</button>`,
        style: "z-index:9999",
      })
    );
    let $t = $("#MBLsheet-conditionformat-dialog")
        .find(".MBLsheet-modal-dialog-content")
        .css("min-width", 300)
        .end(),
      myh = $t.outerHeight(),
    ...
    let scrollLeft = $(document).scrollLeft(),
      scrollTop = $(document).scrollTop();
    $("#MBLsheet-conditionformat-dialog")
      .css({
        left: (winw + scrollLeft - myw) / 2,
        top: (winh + scrollTop - myh) / 3,
      })
    ...
    if (title == locale().conditionformat.conditionformat_occurrenceDate) {
      _this.daterangeInit("MBLsheet-conditionformat-dialog");
    }
  },
  CFiconsDialog: function () {
    $("#MBLsheet-modal-dialog-mask").show();
    $("#MBLsheet-CFicons-dialog").remove();
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-CFicons-dialog",
        addclass: "MBLsheet-CFicons-dialog",
        title: conditionformat_Text.icons,
        content: content,
        botton: `<button class="btn btn-default MBLsheet-model-close-btn">${conditionformat_Text.close}</button>`,
        style: "z-index:100003",
      })
    );
    let $t = $("#MBLsheet-CFicons-dialog")
        .find(".MBLsheet-modal-dialog-content")
        .css("min-width", 400)
        .end(),
      myh = $t.outerHeight(),
  ...
  administerRuleDialog: function () {
    $("#MBLsheet-modal-dialog-mask").show();
    $("#MBLsheet-administerRule-dialog").remove();

    const conditionformat_Text = locale().conditionformat;

    //工作表
    let opHtml = "";
    for (let j = 0; j < Store.MBLsheetfile.length; j++) {
      if (Store.MBLsheetfile[j].status == "1") {
        opHtml += `<option value="${Store.MBLsheetfile[j]["index"]}" selected="selected">
                                ${conditionformat_Text.currentSheet}：${Store.MBLsheetfile[j]["name"]}
                            </option>`;
      } else {
        opHtml += `<option value="${Store.MBLsheetfile[j]["index"]}">
                                ${conditionformat_Text.sheet}：${Store.MBLsheetfile[j]["name"]}
                            </option>`;
      }
    }
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-administerRule-dialog",
        addclass: "MBLsheet-administerRule-dialog",
        title: conditionformat_Text.conditionformatManageRules,
        content: content,
        botton: `<button id="MBLsheet-administerRule-dialog-confirm" class="btn btn-primary">${conditionformat_Text.confirm}</button>
                        <button id="MBLsheet-administerRule-dialog-close" class="btn btn-default">${conditionformat_Text.close}</button>`,
        style: "z-index:100003",
      })
    );
    let $t = $("#MBLsheet-administerRule-dialog")
        .find(".MBLsheet-modal-dialog-content")
        .css("min-width", 400)
        .end(),
      myh = $t.outerHeight(),
    ...
    let scrollLeft = $(document).scrollLeft(),
      scrollTop = $(document).scrollTop();
    $("#MBLsheet-administerRule-dialog")
      .css({
        left: (winw + scrollLeft - myw) / 2,
        top: (winh + scrollTop - myh) / 3,
      })
  ...
  getConditionRuleList: function (index) {
    ...
    $("#MBLsheet-administerRule-dialog .ruleList .listBox").empty();

    let ruleArr =
      _this.fileClone[getSheetIndex(index)].MBLsheet_conditionformat_save; //条件格式规则集合
    if (ruleArr != null && ruleArr.length > 0) {
      ...
      for (let i = 0; i < ruleArr.length; i++) {
        ...
        $("#MBLsheet-administerRule-dialog .ruleList .listBox").prepend(
          itemHtml
        );
      }

      $("#MBLsheet-administerRule-dialog .ruleList .listBox .item canvas").each(
        function (i) {
  ...
  newConditionRuleDialog: function (source) {
    ...
    $("#MBLsheet-modal-dialog-mask").show();
    $("#MBLsheet-administerRule-dialog").hide();
    $("#MBLsheet-newConditionRule-dialog").remove();
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-newConditionRule-dialog",
        addclass: "MBLsheet-newEditorRule-dialog",
        title: conditionformat_Text.newFormatRule,
        content: content,
        botton: `<button id="MBLsheet-newConditionRule-dialog-confirm" class="btn btn-primary" data-source="${source}">${conditionformat_Text.confirm}</button>
                        <button id="MBLsheet-newConditionRule-dialog-close" class="btn btn-default" data-source="${source}">${conditionformat_Text.cancel}</button>`,
        style: "z-index:100003",
      })
    );
    let $t = $("#MBLsheet-newConditionRule-dialog")
        .find(".MBLsheet-modal-dialog-content")
        .css("min-width", 400)
        .end(),
      myh = $t.outerHeight(),
    ...
    //index的规则类型focus
    $("#MBLsheet-newConditionRule-dialog .ruleTypeBox .ruleTypeItem:eq(0)")
      .addClass("on")
      .siblings()
      .removeClass("on");
  ...
  editorConditionRuleDialog: function () {
    ...
    $("#MBLsheet-modal-dialog-mask").show();
    $("#MBLsheet-administerRule-dialog").hide();
    $("#MBLsheet-editorConditionRule-dialog").remove();
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-editorConditionRule-dialog",
        addclass: "MBLsheet-newEditorRule-dialog",
        title: conditionformat_Text.editFormatRule,
        content: content,
        botton: `<button id="MBLsheet-editorConditionRule-dialog-confirm" class="btn btn-primary">${conditionformat_Text.confirm}</button>
                        <button id="MBLsheet-editorConditionRule-dialog-close" class="btn btn-default">${conditionformat_Text.cancel}</button>`,
        style: "z-index:100003",
      })
    );
    let $t = $("#MBLsheet-editorConditionRule-dialog")
        .find(".MBLsheet-modal-dialog-content")
        .css("min-width", 400)
        .end(),
      myh = $t.outerHeight(),
    ...
    //规则类型focus
    $(
      "#MBLsheet-editorConditionRule-dialog .ruleTypeBox .ruleTypeItem:eq(" +
        index +
        ")"
    )
      .addClass("on")
    ...
    //type1
    $("#MBLsheet-editorConditionRule-dialog #type1").val(type1);
    if (
      type1 == "dataBar" ||
      ...
      $("#MBLsheet-editorConditionRule-dialog ." + type1 + "Box").show();
      $("#MBLsheet-editorConditionRule-dialog ." + type1 + "Box")
        .siblings()
        .hide();
    }

    if (type1 == "date") {
      _this.daterangeInit("MBLsheet-editorConditionRule-dialog");
    }
    ...
    if (
      ...
      if (type1 == "dataBar") {
        if (ruleFormat.length == 2) {
          $("#MBLsheet-editorConditionRule-dialog .dataBarBox #type2").val(
            "gradient"
          );
        ...
        $(
          "#MBLsheet-editorConditionRule-dialog .dataBarBox .MBLsheet-conditionformat-config-color"
        ).spectrum("set", ruleFormat[0]);
      } else if (type1 == "colorGradation") {
        if (ruleFormat.length == 3) {
          $(
            "#MBLsheet-editorConditionRule-dialog .colorGradationBox #type2"
          ).val("threeColor");

          $(
            "#MBLsheet-editorConditionRule-dialog .colorGradationBox .midVal"
          ).show();

          $(
            "#MBLsheet-editorConditionRule-dialog .colorGradationBox .maxVal .MBLsheet-conditionformat-config-color"
          ).spectrum("set", ruleFormat[0]);
          $(
            "#MBLsheet-editorConditionRule-dialog .colorGradationBox .midVal .MBLsheet-conditionformat-config-color"
          ).spectrum("set", ruleFormat[1]);
          $(
            "#MBLsheet-editorConditionRule-dialog .colorGradationBox .minVal .MBLsheet-conditionformat-config-color"
        ...
        $("#MBLsheet-editorConditionRule-dialog .iconsBox li").each(function (
          i,
          e
        ) {
          if (
            ...
            $(
              "#MBLsheet-editorConditionRule-dialog .iconsBox .showbox .model"
            ).css(
              "background-position",
      ...
      if (type1 == "number") {
        $("#MBLsheet-editorConditionRule-dialog .numberBox #type2").val(
          conditionName
        );
        ...
        $(
          "#MBLsheet-editorConditionRule-dialog .numberBox #conditionVal input"
        ).val(val1);

        if (conditionName == "betweenness") {
          $("#MBLsheet-editorConditionRule-dialog .numberBox .txt").show();
          $(
            "#MBLsheet-editorConditionRule-dialog .numberBox #conditionVal2"
          ).show();
          ...
          $(
            "#MBLsheet-editorConditionRule-dialog .numberBox #conditionVal2 input"
          ).val(val2);
        } else {
          $("#MBLsheet-editorConditionRule-dialog .numberBox .txt").hide();
          $(
            "#MBLsheet-editorConditionRule-dialog .numberBox #conditionVal2"
          ).hide();
        }
        ...
        $(
          "#MBLsheet-editorConditionRule-dialog .textBox #conditionVal input"
        ).val(val1);
      } else if (type1 == "date") {
        _this.daterangeInit("MBLsheet-editorConditionRule-dialog");

        let val1 = rule.conditionValue[0];
        $("#MBLsheet-editorConditionRule-dialog .dateBox #daterange-btn").val(
          val1
        );
        ...
        if (conditionName == "top10%" || conditionName == "last10%") {
          $("#MBLsheet-editorConditionRule-dialog #isPercent").attr(
            "checked",
            "checked"
          );
        }
      ...
      $("#MBLsheet-editorConditionRule-dialog #textcolorshow").spectrum(
        "set",
        ruleFormat.textColor
      );
      $("#MBLsheet-editorConditionRule-dialog #cellcolorshow").spectrum(
        "set",
  ...
  infoDialog: function (title, content) {
    $("#MBLsheet-modal-dialog-mask").show();
    $("#MBLsheet-conditionformat-info-dialog").remove();
    $("body").append(
      replaceHtml(modelHTML, {
        id: "MBLsheet-conditionformat-info-dialog",
        addclass: "",
        title: title,
        content: content,
        botton: `<button id="MBLsheet-conditionformat-info-dialog-close" class="btn btn-default">${
          locale().conditionformat.close
        }</button>`,
        style: "z-index:100003",
      })
    );
    let $t = $("#MBLsheet-conditionformat-info-dialog")
        .find(".MBLsheet-modal-dialog-content")
        .css("min-width", 300)
        .end(),
      myh = $t.outerHeight(),
    ...
    let scrollLeft = $(document).scrollLeft(),
      scrollTop = $(document).scrollTop();
    $("#MBLsheet-conditionformat-info-dialog")
      .css({
        left: (winw + scrollLeft - myw) / 2,
        top: (winh + scrollTop - myh) / 3,
      })
                                    ...
                                    <div>
                                        <div class="type1Box dataBarBox">
                                            ...
                                            <div style="height: 30px;margin-bottom: 5px;">
                                                ...
                                                <input data-tips="${conditionformat_Text.dataBarColor}" data-func="background" class="MBLsheet-conditionformat-config-color" type="text" value="#638ec6" style="display: none;"> 
                                            </div>
                                        </div>
                                        <div class="type1Box colorGradationBox" style="display: none;">
                                            ...
                                            <div class="maxVal" style="height: 30px;margin-bottom: 5px;">
                                                ...
                                                <input data-tips="${conditionformat_Text.maxValue} ${conditionformat_Text.color}" data-func="background" class="MBLsheet-conditionformat-config-color" type="text" value="rgb(99, 190, 123)" style="display: none;">
                                            </div>
                                            <div class="midVal" style="height: 30px;margin-bottom: 5px;">
                                                ...
                                                <input data-tips="${conditionformat_Text.medianValue} ${conditionformat_Text.color}" data-func="background" class="MBLsheet-conditionformat-config-color" type="text" value="rgb(255, 235, 132)" style="display: none;">
                                            </div>
                                            <div class="minVal" style="height: 30px;margin-bottom: 5px;">
                                                ...
                                                <input data-tips="${conditionformat_Text.minValue} ${conditionformat_Text.color}" data-func="background" class="MBLsheet-conditionformat-config-color" type="text" value="rgb(248, 105, 107)" style="display: none;">
                                            </div>
                                        </div>
  ...
  getComputeMap: function (sheetIndex) {
    ...
    let ruleArr = Store.MBLsheetfile[index]["MBLsheet_conditionformat_save"];
    let data = Store.MBLsheetfile[index]["data"];
  ...
  updateItem: function (type, cellrange, format) {
    ...
    if (type == "delSheet") {
      ...
      ruleArr =
        Store.MBLsheetfile[index]["MBLsheet_conditionformat_save"] == null
          ? []
          : Store.MBLsheetfile[index]["MBLsheet_conditionformat_save"];
      ruleArr.push(rule);
    }

    Store.MBLsheetfile[index]["MBLsheet_conditionformat_save"] = ruleArr;
  ...
  getHistoryRules: function (fileH) {
    ...
    for (let h = 0; h < fileH.length; h++) {
      historyRules.push({
        ...
        MBLsheet_conditionformat_save:
          fileH[h]["MBLsheet_conditionformat_save"],
      });
    }
  ...
  getCurrentRules: function (fileC) {
    ...
    for (let c = 0; c < fileC.length; c++) {
      currentRules.push({
        ...
        MBLsheet_conditionformat_save:
          fileC[c]["MBLsheet_conditionformat_save"],
      });
    }
