...
import { getSheetIndex, get_MBLsheetfile, getRangetxt } from "../methods/get";
...
const functionImplementation = {
    ...
    try {
      ...
      if (dataArr.length > 0) {
        for (var i = 0; i < dataArr.length; i++) {
          ...
          sum = MBLsheet_calcADPMM(sum, "+", dataArr[i]); // parseFloat(dataArr[i]);
        }
      }
  ...
  AVERAGE: function () {
    ...
    try {
      ...
      return MBLsheet_calcADPMM(sum, "/", count); // sum / count;
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
      return [formula.error.v, err];
  ...
  AGE_BY_IDCARD: function () {
    ...
    try {
      ...
      if (!window.MBLsheet_function.ISIDCARD.f(UUserCard)) {
        return formula.error.v;
      }

      var birthday = window.MBLsheet_function.BIRTHDAY_BY_IDCARD.f(UUserCard);
  ...
  DM_TEXT_CUTWORD: function () {
    ...
    try {
      var cell_r = window.MBLsheetCurrentRow;
      var cell_c = window.MBLsheetCurrentColumn;
      var cell_fp = window.MBLsheetCurrentFunction;
  ...
  SUMIF: function () {
    ...
    try {
      ...
      var criteria = MBLsheet_parseData(arguments[1]);
      ...
      if (arguments[2]) {
        ...
        if (rangeRow == sumRangeRow && rangeCol == sumRangeCol) {
          ...
          sumRangeData = MBLsheet_getcelldata(realSumRange).data;
        ...
        for (var i = 0; i < rangeData.length; i++) {
          ...
          if (!!v && formula.acompareb(v, criteria)) {
            ...
            sum = MBLsheet_calcADPMM(sum, "+", sumRangeData[i]); // parseFloat(sumRangeData[i]);
          }
        }
      } else {
        //循环遍历查找匹配项
        for (var i = 0; i < rangeData.length; i++) {
          ...
          if (!!v && formula.acompareb(v, criteria)) {
            ...
            sum = MBLsheet_calcADPMM(sum, "", v); // parseFloat(v);
          }
        }
      }
    ...
    try {
      ...
      if (getObjType(data) == "array") {
        ...
        if (data.rowl > 1) {
          ...
          if (
            window.MBLsheetCurrentRow < str ||
            window.MBLsheetCurrentRow > str + data.rowl - 1
          ) {
            return formula.error.v;
          }

          var cell = data.data[window.MBLsheetCurrentRow - str][0];
        } else {
          var cell = data.data;
        }
    ...
    try {
      ...
      function compute(function_num) {
        switch (function_num) {
          case 1: //AVERAGE
          case 101:
            return window.MBLsheet_function.AVERAGE.f.apply(
              window.MBLsheet_function.AVERAGE,
              arr
            );
            break;
          case 2: //COUNT
          case 102:
            return window.MBLsheet_function.COUNT.f.apply(
              window.MBLsheet_function.COUNT,
              arr
            );
            break;
          case 3: //COUNTA
          case 103:
            return window.MBLsheet_function.COUNTA.f.apply(
              window.MBLsheet_function.COUNTA,
              arr
            );
            break;
          case 4: //MAX
          case 104:
            return window.MBLsheet_function.MAX.f.apply(
              window.MBLsheet_function.MAX,
              arr
            );
            break;
          case 5: //MIN
          case 105:
            return window.MBLsheet_function.MIN.f.apply(
              window.MBLsheet_function.MIN,
              arr
            );
            break;
          case 6: //PRODUCT
          case 106:
            return window.MBLsheet_function.PRODUCT.f.apply(
              window.MBLsheet_function.PRODUCT,
              arr
            );
            break;
          case 7: //STDEV
          case 107:
            return window.MBLsheet_function.STDEVA.f.apply(
              window.MBLsheet_function.STDEVA,
              arr
            );
            break;
          case 8: //STDEVP
          case 108:
            return window.MBLsheet_function.STDEVP.f.apply(
              window.MBLsheet_function.STDEVP,
              arr
            );
            break;
          case 9: //SUM
          case 109:
            return window.MBLsheet_function.SUM.f.apply(
              window.MBLsheet_function.SUM,
              arr
            );
            break;
          case 10: //VAR
          case 110:
            return window.MBLsheet_function.VAR_S.f.apply(
              window.MBLsheet_function.VAR_S,
              arr
            );
            break;
          case 11: //VARP
          case 111:
            return window.MBLsheet_function.VAR_P.f.apply(
              window.MBLsheet_function.VAR_P,
              arr
            );
            break;
        }
  ...
  COUNTUNIQUE: function () {
    ...
    try {
      ...
      return window.MBLsheet_function.UNIQUE.f(dataArr);
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
      return [formula.error.v, err];
  ...
  SUMIFS: function () {
    ...
    try {
      ...
      for (var i = 0; i < rangeData.length; i++) {
        if (results[i]) {
          sum = MBLsheet_calcADPMM(sum, "+", rangeData[i]); //parseFloat(rangeData[i]);
        }
      }
  ...
  PERCENTRANK_EXC: function () {
    ...
    try {
      ...
      var uniques = window.MBLsheet_function.UNIQUE.f(ref_n)[0];
  ...
  TRIMMEAN: function () {
    ...
    try {
      ...
      var trim =
        window.MBLsheet_function.FLOOR.f(dataArr_n.length * percent, 2) / 2;
  ...
  Z_TEST: function () {
    ...
    try {
      ...
      //计算
      var n = dataArr_n.length;
      var mean = window.MBLsheet_function.AVERAGE.f.apply(
        window.MBLsheet_function.AVERAGE,
        dataArr_n
      );
      ...
      return (
        1 -
        window.MBLsheet_function.NORM_S_DIST.f(
  ...
  QUARTILE_EXC: function () {
    ...
    try {
      ...
      switch (quart) {
        case 1:
          return window.MBLsheet_function.PERCENTILE_EXC.f(array, 0.25);
        case 2:
          return window.MBLsheet_function.PERCENTILE_EXC.f(array, 0.5);
        case 3:
          return window.MBLsheet_function.PERCENTILE_EXC.f(array, 0.75);
      }
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
  ...
  QUARTILE_INC: function () {
    ...
    try {
      ...
      switch (quart) {
        ...
        case 1:
          return window.MBLsheet_function.PERCENTILE_INC.f(array, 0.25);
        case 2:
          return window.MBLsheet_function.PERCENTILE_INC.f(array, 0.5);
        case 3:
          return window.MBLsheet_function.PERCENTILE_INC.f(array, 0.75);
        case 4:
  ...
  RSQ: function () {
    ...
    try {
      ...
      return Math.pow(window.MBLsheet_function.PEARSON.f(data_y, data_x), 2);
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
      return [formula.error.v, err];
  ...
  T_TEST: function () {
    ...
    try {
      ...
      if (tails == 1) {
        var result = window.MBLsheet_function.T_DIST_RT.f(t, df);
      } else if (tails == 2) {
        var result = window.MBLsheet_function.T_DIST_2T.f(t, df);
      }
  ...
  INDIRECT: function () {
    ...
    try {
      ...
      let currentSheet = MBLsheetfile[index];
  ...
  ROW: function () {
    ...
    try {
      if (arguments.length == 1) {
        ...
        return window.MBLsheetCurrentRow + 1;
      }
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
  ...
  COLUMN: function () {
    ...
    try {
      if (arguments.length == 1) {
        ...
        return window.MBLsheetCurrentColumn + 1;
      }
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
  ...
  OFFSET: function () {
    ...
    try {
      ...
      let MBLsheetfile = get_MBLsheetfile();
      let index = getSheetIndex(Store.calculateSheetIndex);
      let sheetdata = MBLsheetfile[index].data;
  ...
  NETWORKDAYS: function () {
    ...
    try {
      if (arguments.length == 3) {
        var result = window.MBLsheet_function.NETWORKDAYS_INTL.f(
          arguments[0],
          arguments[1],
          1,
          arguments[2]
  ...
  WEEKNUM: function () {
    ...
    try {
      ...
      if (return_type == 21) {
        return window.MBLsheet_function.ISOWEEKNUM.f(arguments[0]);
      }
  ...
  DATEDIF: function () {
    ...
    try {
      ...
      if (window.MBLsheet_function.DAYS.f(endDate, startDate) < 0) {
        return formula.error.v;
      }
  ...
  WORKDAY: function () {
    ...
    try {
      if (arguments.length == 3) {
        var result = window.MBLsheet_function.WORKDAY_INTL.f(
          arguments[0],
          arguments[1],
          1,
          arguments[2]
  ...
  CUMPRINC: function () {
    ...
    try {
      ...
      //计算
      var payment = window.MBLsheet_function.PMT.f(rate, nper, pv, 0, type);
      var principal = 0;
      ...
      for (var i = start_period; i <= end_period; i++) {
        if (type > 0) {
          principal +=
            payment -
            (window.MBLsheet_function.FV.f(rate, i - 2, payment, pv, 1) -
              payment) *
              rate;
        } else {
          principal +=
            payment -
            window.MBLsheet_function.FV.f(rate, i - 1, payment, pv, 0) * rate;
        }
      }
  ...
  YIELD: function () {
    ...
    try {
      ...
      //计算
      var num = window.MBLsheet_function.COUPNUM.f(
        settlement,
        maturity,
        frequency,
        basis
      ...
      if (num > 1) {
        ...
        for (var i = 1; i <= 100; i++) {
          var price = window.MBLsheet_function.PRICE.f(
            settlement,
            maturity,
            rate,
            yld,
        ...
        var DSR = window.MBLsheet_function.COUPDAYSNC.f(
          settlement,
          maturity,
          frequency,
          basis
        );
        var E = window.MBLsheet_function.COUPDAYS.f(
          settlement,
          maturity,
          frequency,
          basis
        );
        var A = window.MBLsheet_function.COUPDAYBS.f(
          settlement,
          maturity,
          frequency,
          basis
  ...
  YIELDDISC: function () {
    ...
    try {
      ...
      var yearfrac = window.MBLsheet_function.YEARFRAC.f(
        settlement,
        maturity,
        basis
      );
  ...
  XIRR: function () {
    ...
    try {
      ...
      var irrResult = function (values, dates, rate) {
        ...
        for (var i = 1; i < values.length; i++) {
          result +=
            ...
            Math.pow(
              r,
              window.MBLsheet_function.DAYS.f(dates[i], dates[0]) / 365
            );
        }
      ...
      var irrResultDeriv = function (values, dates, rate) {
        ...
        for (var i = 1; i < values.length; i++) {
          var frac = window.MBLsheet_function.DAYS.f(dates[i], dates[0]) / 365;
  ...
  MIRR: function () {
    ...
    try {
      ...
      var num =
        -window.MBLsheet_function.NPV.f(reinvest_rate, incomes) *
        Math.pow(1 + reinvest_rate, n - 1);
      var den =
        window.MBLsheet_function.NPV.f(finance_rate, payments) *
        (1 + finance_rate);
  ...
  IRR: function () {
    ...
    try {
      ...
      var irrResult = function (values, dates, rate) {
        ...
        for (var i = 1; i < values.length; i++) {
          // result += values[i] / Math.pow(r, window.MBLsheet_function.DAYS.f(dates[i], dates[0]) / 365);
    ...
    try {
      ...
      for (var i = start_period; i <= end_period; i++) {
        if (type === 1) {
          ...
          interest += window.MBLsheet_function.FV.f(
            rate,
            i - 1,
            payment,
            pv,
  ...
  IPMT: function () {
    ...
    try {
      ...
      //计算
      var payment = window.MBLsheet_function.PMT.f(rate, nper, pv, fv, type);
      var interest;
      ...
      if (per === 1) {
        ...
        if (type === 1) {
          interest =
            window.MBLsheet_function.FV.f(rate, per - 2, payment, pv, 1) -
            payment;
        } else {
          interest = window.MBLsheet_function.FV.f(
            rate,
  ...
  PPMT: function () {
    ...
    try {
      ...
      //计算
      var payment = window.MBLsheet_function.PMT.f(rate, nper, pv, fv, type);
      var payment2 = window.MBLsheet_function.IPMT.f(
        rate,
        per,
        nper,
        pv,
  ...
  PRICE: function () {
    ...
    try {
      ...
      //计算
      var DSC = window.MBLsheet_function.COUPDAYSNC.f(
        settlement,
        maturity,
        frequency,
        basis
  ...
  DURATION: function () {
    ...
    try {
      ...
      var nper = window.MBLsheet_function.COUPNUM.f(
        settlement,
        maturity,
        frequency,
        basis
  ...
  MDURATION: function () {
    ...
    try {
      ...
      var duration = window.MBLsheet_function.DURATION.f(
        settlement,
        maturity,
        coupon,
        yld,
  ...
  IMCONJUGATE: function () {
    ...
    try {
      ...
      var x = window.MBLsheet_function.IMREAL.f(inumber);
      if (valueIsError(x)) {
        return x;
      }

      var y = window.MBLsheet_function.IMAGINARY.f(inumber);
      if (valueIsError(y)) {
        return y;
      }
      ...
      return y !== 0
        ? window.MBLsheet_function.COMPLEX.f(x, -y, unit)
        : inumber;
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
  ...
  IMABS: function () {
    ...
    try {
      var x = window.MBLsheet_function.IMREAL.f(arguments[0]);
      if (valueIsError(x)) {
        return x;
      }

      var y = window.MBLsheet_function.IMAGINARY.f(arguments[0]);
      if (valueIsError(y)) {
        return y;
      }
  ...
  IMSUM: function () {
    ...
    try {
      ...
      for (var i = 1; i < arguments.length; i++) {
        var a = window.MBLsheet_function.IMREAL.f(result);
        if (valueIsError(a)) {
          return a;
        }

        var b = window.MBLsheet_function.IMAGINARY.f(result);
        if (valueIsError(b)) {
          return b;
        }

        var c = window.MBLsheet_function.IMREAL.f(arguments[i]);
        if (valueIsError(c)) {
          return c;
        }

        var d = window.MBLsheet_function.IMAGINARY.f(arguments[i]);
        if (valueIsError(d)) {
          return d;
        }

        result = window.MBLsheet_function.COMPLEX.f(a + c, b + d);
      }
  ...
  IMSUB: function () {
    ...
    try {
      ...
      var a = window.MBLsheet_function.IMREAL.f(inumber1);
      if (valueIsError(a)) {
        return a;
      }

      var b = window.MBLsheet_function.IMAGINARY.f(inumber1);
      if (valueIsError(b)) {
        return b;
      }
      ...
      var c = window.MBLsheet_function.IMREAL.f(inumber2);
      if (valueIsError(c)) {
        return c;
      }

      var d = window.MBLsheet_function.IMAGINARY.f(inumber2);
      if (valueIsError(d)) {
        return d;
      }
      ...
      return window.MBLsheet_function.COMPLEX.f(a - c, b - d, unit);
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
      return [formula.error.v, err];
  ...
  IMPRODUCT: function () {
    ...
    try {
      ...
      for (var i = 1; i < arguments.length; i++) {
        ...
        result = window.MBLsheet_function.COMPLEX.f(
          a * c - b * d,
          a * d + b * c
        );
      }
  ...
  IMDIV: function () {
    ...
    try {
      ...
      return window.MBLsheet_function.COMPLEX.f(
        (a * c + b * d) / den,
        (b * c - a * d) / den,
        unit
      );
  ...
  CELL: function () {
    ...
    try {
      ...
      var file = get_MBLsheetfile()[getSheetIndex(Store.currentSheetIndex)];
  ...
  LINESPLINES: function () {
    ...
    try {
      ...
      //设置sparklines图表的宽高，线图的高会随着粗细而超出单元格高度，所以减去一个量，设置offsetY或者offsetX为渲染偏移量，传给MBLsheetDrawMain使用。默认为0。=LINESPLINES(D9:E24,3,5)
      ...
      if (!!normalValue) {
        if (typeof normalValue == "string") {
          ...
          var nv = null;
          if (normalValue == "min") {
            nv = window.MBLsheet_function.MIN.f({ data: dataformat });
          } else if (normalValue == "max") {
            nv = window.MBLsheet_function.MAX.f({ data: dataformat });
          } else if (normalValue == "avg" || normalValue == "mean") {
            nv = window.MBLsheet_function.AVERAGE.f({ data: dataformat });
          } else if (normalValue == "median") {
            nv = window.MBLsheet_function.MEDIAN.f({ data: dataformat });
          }
      ...
      var temp1 = MBLsheetSparkline.init(dataformat, sparksetting);
  ...
  EVALUATE: function () {
    ...
    try {
      var cell_r = window.MBLsheetCurrentRow;
      var cell_c = window.MBLsheetCurrentColumn;
      var sheetindex_now = window.MBLsheetCurrentIndex;
      //公式文本
  ...
  REMOTE: function () {
    ...
    try {
      const cellRow = window.MBLsheetCurrentRow;
      const cellColumn = window.MBLsheetCurrentColumn;
      const cellFunction = window.MBLsheetCurrentFunction;
      ...
      MBLsheetConfigsetting.remoteFunction(remoteFunction, (data) => {
