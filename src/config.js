/**
 * The default MBLsheet config object.
 */
export default {
  container: "MBLsheet", //容器的ID
  loading: {}, //自定义loading
  column: 60, //空表格默认的列数量
  row: 84, //空表格默认的行数据量
  ...
  loadUrl: "", // 配置loadUrl的地址，MBLsheet会通过ajax请求表格数据，默认载入status为1的sheet数据中的所有data，其余的sheet载入除data字段外的所有字段
