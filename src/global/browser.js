const browser = {
  ...
  MBLsheetrefreshfixednum: null,
  MBLsheetrefreshfixed: function () {
    var _this = this;
    if (_this.MBLsheetrefreshfixednum == null) {
      if (_this.BrowserType() == "FF") {
        _this.MBLsheetrefreshfixednum = 5;
      } else {
        _this.MBLsheetrefreshfixednum = 0;
      }
    }

    return _this.MBLsheetrefreshfixednum;
  },
  detectOS() {
