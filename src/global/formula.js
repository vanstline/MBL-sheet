...
import { MBLsheetRangeLast } from "./cursorPos";
import { jfrefreshgrid } from "./refresh";
import {
  isInlineStringCell,
  convertSpanToShareString,
} from "../controllers/inlineString";
// import MBLsheet_function from '../function/MBLsheet_function';
// import functionlist from '../function/functionlist';
import {
  MBLsheet_compareWith,
  MBLsheet_getarraydata,
  MBLsheet_getcelldata,
  MBLsheet_parseData,
  MBLsheet_getValue,
  MBLsheet_indirect_check,
  MBLsheet_indirect_check_return,
  MBLsheet_offset_check,
  MBLsheet_calcADPMM,
  MBLsheet_getSpecialReference,
} from "../function/func";
...
const MBLsheetformula = {
  ...
  //sparklines添加
  //获得函数里某个参数的值，使用此函数需要在函数中执行MBLsheet_getValue方法
  getValueByFuncData: function (value, arg) {
    ...
    if (getObjType(value) == "array") {
      if (arg == "avg") {
        return MBLsheet_function.AVERAGE.f.apply(
          MBLsheet_function.AVERAGE,
          value
        );
      } else if (arg == "sum") {
        return MBLsheet_function.SUM.f.apply(MBLsheet_function.SUM, value);
      } else {
        if (getObjType(value[0]) == "object") {
          return MBLsheet.mask.getValueByFormat(value[0]);
        } else {
          return value[0];
        }
      }
    } else if (getObjType(value) == "object") {
      return MBLsheet.mask.getValueByFormat(value);
    } else {
      return value;
    }
  },
  ...
  dontupdate: function () {
    let _this = this;
    Store.MBLsheetCellUpdate.length = 0; //clear array
    $("#MBLsheet-functionbox-cell, #MBLsheet-rich-text-editor").html(
      _this.oldvalue
    );
  ...
  fucntionboxshow: function (r, c) {
    ...
    $("#MBLsheet-functionbox-cell").html(value);
  },
  ...
  acompareb: function (a, b) {
    ...
    if (isRealNum(b)) {
      ...
      if (b.indexOf("*") != -1 || b.indexOf("?") != -1) {
        ...
        flag = MBLsheet_compareWith(a, ope, num);
      } else {
        flag = MBLsheet_compareWith(a, "==", b);
      }
    }
  ...
  getcellrange: function (txt, formulaIndex) {
    ...
    let MBLsheetfile = get_MBLsheetfile();
    ...
    if (txt.indexOf("!") > -1) {
      ...
      for (let i in MBLsheetfile) {
        if (sheettxt == MBLsheetfile[i].name) {
          sheetIndex = MBLsheetfile[i].index;
          sheetdata = MBLsheetfile[i].data;
          break;
        }
      }
    } else {
      ...
      sheettxt = MBLsheetfile[index].name;
      sheetIndex = MBLsheetfile[index].index;
  ...
  rangeHightlightHTML:
    '<div id="MBLsheet-formula-functionrange-highlight-${id}" rangeindex="${id}"  class="MBLsheet-selection-highlight MBLsheet-formula-functionrange-highlight"><div data-type="top" class="MBLsheet-selection-copy-top MBLsheet-copy"></div><div data-type="right" class="MBLsheet-selection-copy-right MBLsheet-copy"></div><div data-type="bottom" class="MBLsheet-selection-copy-bottom MBLsheet-copy"></div><div data-type="left" class="MBLsheet-selection-copy-left MBLsheet-copy"></div><div class="MBLsheet-selection-copy-hc"></div><div data-type="lt" class="MBLsheet-selection-highlight-topleft MBLsheet-highlight"></div><div data-type="rt" class="MBLsheet-selection-highlight-topright MBLsheet-highlight"></div><div data-type="lb" class="MBLsheet-selection-highlight-bottomleft MBLsheet-highlight"></div><div data-type="rb" class="MBLsheet-selection-highlight-bottomright MBLsheet-highlight"></div></div>',
  createRangeHightlight: function () {
    let _this = this;

    let $span = $("#MBLsheet-rich-text-editor").find(
      "span.MBLsheet-formula-functionrange-cell"
    );
    $(
    ...
    $span.each(function () {
      ...
      $("#MBLsheet-formula-functionrange").append(
      ...
      let rangeid = "MBLsheet-formula-functionrange-highlight-" + rangeindex;
  ...
  searchHTML:
    '<div id="MBLsheet-formula-search-c" class="MBLsheet-formula-search-c"></div>',
  helpHTML:
    '<div id="MBLsheet-formula-help-c" class="MBLsheet-formula-help-c"> <div class="MBLsheet-formula-help-close" title="${helpClose}"><i class="fa fa-times" aria-hidden="true"></i></div> <div class="MBLsheet-formula-help-collapse" title="${helpCollapse}"><i class="fa fa-angle-up" aria-hidden="true"></i></div> <div class="MBLsheet-formula-help-title"><div class="MBLsheet-formula-help-title-formula"> <span class="MBLsheet-arguments-help-function-name">SUM</span> <span class="MBLsheet-arguments-paren">(</span> <span class="MBLsheet-arguments-parameter-holder"> <span class="MBLsheet-arguments-help-parameter MBLsheet-arguments-help-parameter-active" dir="auto">A2:A100</span>, <span class="MBLsheet-arguments-help-parameter" dir="auto">101</span> </span> <span class="MBLsheet-arguments-paren">)</span> </div></div> <div class="MBLsheet-formula-help-content"> <div class="MBLsheet-formula-help-content-example"> <div class="MBLsheet-arguments-help-section-title">${helpExample}</div> <div class="MBLsheet-arguments-help-formula"> <span class="MBLsheet-arguments-help-function-name">SUM</span> <span class="MBLsheet-arguments-paren">(</span> <span class="MBLsheet-arguments-parameter-holder"> <span class="MBLsheet-arguments-help-parameter MBLsheet-arguments-help-parameter-active" dir="auto">A2:A100</span>, <span class="MBLsheet-arguments-help-parameter" dir="auto">101</span> </span> <span class="MBLsheet-arguments-paren">)</span> </div> </div> <div class="MBLsheet-formula-help-content-detail"> <div class="MBLsheet-arguments-help-section"> <div class="MBLsheet-arguments-help-section-title MBLsheet-arguments-help-parameter-name">${helpAbstract}</div> <span class="MBLsheet-arguments-help-parameter-content">${helpAbstract}</span> </div> </div> <div class="MBLsheet-formula-help-content-param"> ${param} </div> </div> <div class="MBLsheet-formula-help-foot"></div></div>',
  getrangeseleciton: function () {
    ...
    if (anchor.parent().is("span") && anchorOffset != 0) {
      ...
      anchor.is("#MBLsheet-functionbox-cell")
    ) {
      ...
      anchor.parent().is("#MBLsheet-functionbox-cell") ||
      anchorOffset == 0
    ) {
      if (anchorOffset == 0) {
  ...
  searchFunctionPosition: function ($menu, $editor, x, y, isparam) {
    ...
    if (y + menuH > winH) {
      ...
      if (!isparam) {
        $menu.html($menu.find(".MBLsheet-formula-search-item").get().reverse());
      }
    }
  ...
  searchFunction: function ($editer) {
    ...
    $("#MBLsheet-formula-search-c").html(listHTML).show();
  ...
  searchFunctionEnter: function ($obj) {
    ...
    _this.searchFunctionCell
      .text(functxt)
      .after('<span dir="auto" class="MBLsheet-formula-text-color">(</span>');
    _this.setCaretPosition(_this.searchFunctionCell.next().get(0), 0, 1);
    $("#MBLsheet-formula-search-c").hide();
  ...
  searchFunctionHTML: function (list) {
    ...
    if ($("#MBLsheet-formula-search-c").length == 0) {
      $("body").append(_this.searchHTML);
      $("#MBLsheet-formula-search-c")
        .on("mouseover", ".MBLsheet-formula-search-item", function () {
          $("#MBLsheet-formula-search-c")
            .find(".MBLsheet-formula-search-item")
            .removeClass("MBLsheet-formula-search-item-active");
          $(this).addClass("MBLsheet-formula-search-item-active");
        })
        .on("mouseout", ".MBLsheet-formula-search-item", function () {})
        .on("click", ".MBLsheet-formula-search-item", function () {
    ...
    let itemHTML =
      '<div data-func="${n}" class="MBLsheet-formula-search-item ${class}"><div class="MBLsheet-formula-search-func">${n}</div><div class="MBLsheet-formula-search-detail">${a}</div></div>';
    let retHTML = "";
    ...
    for (let i = 0; i < list.length; i++) {
      ...
      if (i == list.length - 1) {
        retHTML += replaceHtml(itemHTML, {
          class: "MBLsheet-formula-search-item-active",
          n: item.n,
          a: item.a,
        });
      } else {
  ...
  helpFunction: function ($editer, funcname, paramIndex) {
    ...
    $("#MBLsheet-formula-help-c .MBLsheet-arguments-help-function-name").html(
      $func.n
    );
    $(
      "#MBLsheet-formula-help-c .MBLsheet-arguments-help-parameter-content"
    ).html($func.d);

    let helpformula =
      '<span class="MBLsheet-arguments-help-function-name">${name}</span> <span class="MBLsheet-arguments-paren">(</span> <span class="MBLsheet-arguments-parameter-holder"> ${param} </span> <span class="MBLsheet-arguments-paren">)</span>';
    let helpformulaItem =
      '<span class="MBLsheet-arguments-help-parameter" dir="auto">${param}</span>';
    let helpformulaArg =
      '<div class="MBLsheet-arguments-help-section"><div class="MBLsheet-arguments-help-section-title">${param}</div><span class="MBLsheet-arguments-help-parameter-content">${content}</span></div>';
    ...
    for (let i = 0; i < $func.p.length; i++) {
      ...
      if (paramitem.repeat == "y") {
        name += ", ...";
        nameli +=
          '<span class="MBLsheet-arguments-help-argument-info">...-' +
      ...
      fht +=
        '<span class="MBLsheet-arguments-help-parameter" dir="auto">' +
        name +
        "</span>, ";
      ahf +=
        '<span class="MBLsheet-arguments-help-parameter" dir="auto">' +
    ...
    $(
      "#MBLsheet-formula-help-c .MBLsheet-formula-help-title .MBLsheet-arguments-parameter-holder"
    ).html(fht); //介绍
    $(
      "#MBLsheet-formula-help-c .MBLsheet-arguments-help-formula .MBLsheet-arguments-parameter-holder"
    ).html(ahf); //示例
    $("#MBLsheet-formula-help-c .MBLsheet-formula-help-content-param").html(
      fhcp
    ); //参数

    if (paramIndex == null) {
      $(
        "#MBLsheet-formula-help-c .MBLsheet-formula-help-title-formula .MBLsheet-arguments-help-function-name"
      ...
      $(
        "#MBLsheet-formula-help-c .MBLsheet-formula-help-title .MBLsheet-arguments-parameter-holder .MBLsheet-arguments-help-parameter"
      ).removeClass("MBLsheet-arguments-help-parameter-active");
      $(
        "#MBLsheet-formula-help-c .MBLsheet-formula-help-title .MBLsheet-arguments-parameter-holder .MBLsheet-arguments-help-parameter"
      )
        .eq(index)
        .addClass("MBLsheet-arguments-help-parameter-active");
      $(
        "#MBLsheet-formula-help-c .MBLsheet-arguments-help-formula .MBLsheet-arguments-parameter-holder .MBLsheet-arguments-help-parameter"
      ).removeClass("MBLsheet-arguments-help-parameter-active");
      $(
        "#MBLsheet-formula-help-c .MBLsheet-arguments-help-formula .MBLsheet-arguments-parameter-holder .MBLsheet-arguments-help-parameter"
      )
        ...
        .addClass("MBLsheet-arguments-help-parameter-active");
      $(
        "#MBLsheet-formula-help-c .MBLsheet-formula-help-content-param .MBLsheet-arguments-help-section"
      ).removeClass("MBLsheet-arguments-help-parameter-active");
      $(
        "#MBLsheet-formula-help-c .MBLsheet-formula-help-content-param .MBLsheet-arguments-help-section"
      )
  ...
  helpFunctionExe: function ($editer, currSelection) {
    ...
    let _locale = locale();
    let locale_formulaMore = _locale.formulaMore;
    if ($("#MBLsheet-formula-help-c").length == 0) {
      $("body").after(
      ...
      $("#MBLsheet-formula-help-c .MBLsheet-formula-help-close").click(
        function () {
          $("#MBLsheet-formula-help-c").hide();
        }
      );
      $("#MBLsheet-formula-help-c .MBLsheet-formula-help-collapse").click(
        function () {
          let $content = $(
            "#MBLsheet-formula-help-c .MBLsheet-formula-help-content"
          );
    ...
    if ($span.eq(i).is(".MBLsheet-formula-text-func")) {
      ...
      while (--i > 0) {
        ...
        if (
          $cur.is(".MBLsheet-formula-text-func") ||
          ...
          for (let a = i; a <= currentIndex; a++) {
            ...
            $cur = $span.eq(a);
            if ($cur.is(".MBLsheet-formula-text-rpar")) {
              exceptIndex = [i, a];
              funcName = null;
              endstate = false;
              break;
            ...
            if ($cur.is(".MBLsheet-formula-text-comma")) {
              paramindex++;
            }
          }
  ...
  rangeHightlightselected: function ($editer, kcode) {
    ...
    $("#MBLsheet-formula-search-c, #MBLsheet-formula-help-c").hide();
    $(
      "#MBLsheet-formula-functionrange .MBLsheet-formula-functionrange-highlight .MBLsheet-selection-copy-hc"
    ).css("opacity", "0.03");
    $("#MBLsheet-formula-search-c, #MBLsheet-formula-help-c").hide();
    _this.helpFunctionExe($editer, currSelection);

    // console.log(currSelection, $(currSelection).closest(".MBLsheet-formula-functionrange-cell").length);
    if (
      $(currSelection).closest(".MBLsheet-formula-functionrange-cell").length ==
      0
    ) {
    ...
    let $anchorOffset = $(currSelection).closest(
      ".MBLsheet-formula-functionrange-cell"
    );
  ...
  updatecell: function (r, c, value, isRefresh = true) {
    ...
    if (getObjType(curv) == "object") {
      if (!isCurInline) {
        ...
        // from API setCellValue,MBLsheet.setCellValue(0, 0, {f: "=sum(D1)", bg:"#0188fb"}),value is an object, so get attribute f as value
        else if (getObjType(value) == "object") {
    ...
    if (
      ...
      // let fontset = MBLsheetfontformat(d[r][c]);
  ...
  cancelNormalSelected: function () {
    ...
    $("#MBLsheet-input-box").removeAttr("style");
    $("#MBLsheet-input-box-index").hide();
    $(
      "#MBLsheet-wa-functionbox-cancel, #MBLsheet-wa-functionbox-confirm"
    ).removeClass("MBLsheet-wa-calculate-active");
  ...
  canceFunctionrangeSelected: function () {
    ...
    // $("#MBLsheet-cols-h-selected, #MBLsheet-rows-h-selected").hide();
    $("#MBLsheet-formula-search-c, #MBLsheet-formula-help-c").hide();
  },
  ...
  rangeSetValue: function (selected, obj) {
    ...
    if (
      ...
      if (
        ...
        $("#MBLsheet-search-formula-parm-select-input").val(range);
        ...
        //参数对应值显示
        let txtdata = MBLsheet_getcelldata(range).data;
        ...
        if (isVal) {
          //公式计算
          let fp = $.trim(
            _this.functionParserExe($("#MBLsheet-rich-text-editor").text())
          );
      ...
      let function_str =
        '<span class="MBLsheet-formula-functionrange-cell" rangeindex="' +
    ...
    if ($editor.attr("id") == "MBLsheet-rich-text-editor") {
      $("#MBLsheet-functionbox-cell").html(
        $("#MBLsheet-rich-text-editor").html()
      );
    } else {
  ...
  rangedrag: function (event) {
    ...
    rowseleted[0] = MBLsheetFreezen.changeFreezenIndex(rowseleted[0], "h");
    rowseleted[1] = MBLsheetFreezen.changeFreezenIndex(rowseleted[1], "h");
    columnseleted[0] = MBLsheetFreezen.changeFreezenIndex(
      columnseleted[0],
      "v"
    );
    columnseleted[1] = MBLsheetFreezen.changeFreezenIndex(
      columnseleted[1],
      "v"
    );
    ...
    MBLsheet_count_show(left, top, width, height, rowseleted, columnseleted);
    ...
    MBLsheetFreezen.scrollFreezen(rowseleted, columnseleted);
  },
  ...
  rangedrag_column: function (event) {
    ...
    MBLsheetFreezen.scrollFreezen([0, row_index], columnseleted);
  },
  rangedrag_row: function (event) {
    ...
    rowseleted[0] = MBLsheetFreezen.changeFreezenIndex(rowseleted[0], "h");
    rowseleted[1] = MBLsheetFreezen.changeFreezenIndex(rowseleted[1], "h");
    // columnseleted[0] = MBLsheetFreezen.changeFreezenIndex(columnseleted[0], "v");
    // columnseleted[1] = MBLsheetFreezen.changeFreezenIndex(columnseleted[1], "v");
    ...
    MBLsheet_count_show(col_pre, top, col - col_pre - 1, height, rowseleted, [
      0,
      col_index,
    ]);
    ...
    MBLsheetFreezen.scrollFreezen(rowseleted, [0, col_index]);
  },
  ...
  rangeResizeDraging: function (
    event,
    MBLsheetCurrentChartResizeObj,
    MBLsheetCurrentChartResizeXy,
    MBLsheetCurrentChartResize,
    MBLsheetCurrentChartResizeWinW,
    MBLsheetCurrentChartResizeWinH,
    ch_width,
    rh_height
  ) {
    let _this = this;

    let scrollTop = $("#MBLsheet-scrollbar-y").scrollTop(),
      scrollLeft = $("#MBLsheet-scrollbar-x").scrollLeft();
    let mouse = mouseposition(event.pageX, event.pageY);
    ...
    let topchange = row_pre - MBLsheetCurrentChartResizeXy[1],
      leftchange = col_pre - MBLsheetCurrentChartResizeXy[0];
    let top = MBLsheetCurrentChartResizeXy[5],
      height = MBLsheetCurrentChartResizeXy[3],
      left = MBLsheetCurrentChartResizeXy[4],
      width = MBLsheetCurrentChartResizeXy[2];

    if (
      MBLsheetCurrentChartResize == "lt" ||
      MBLsheetCurrentChartResize == "lb"
    ) {
      if (
        MBLsheetCurrentChartResizeXy[0] + MBLsheetCurrentChartResizeXy[2] <
        col_pre
      ) {
        return;
      }
      ...
      left = col_pre;
      width = MBLsheetCurrentChartResizeXy[2] - leftchange;

      if (
        left >
        MBLsheetCurrentChartResizeXy[2] +
          MBLsheetCurrentChartResizeXy[4] -
          col +
          col_pre
      ) {
        left =
        ...
        width =
          ...
          (MBLsheetCurrentChartResizeXy[2] +
            ...
            col +
            col_pre -
            MBLsheetCurrentChartResizeXy[0]);
      } else if (left <= 0) {
        left = 0;
        width =
          MBLsheetCurrentChartResizeXy[2] + MBLsheetCurrentChartResizeXy[0];
      }
    }

    if (
      MBLsheetCurrentChartResize == "rt" ||
      MBLsheetCurrentChartResize == "rb"
    ) {
      if (
        MBLsheetCurrentChartResizeXy[6] - MBLsheetCurrentChartResizeXy[2] >
        col
      ) {
        return;
      }
      ...
      width =
        MBLsheetCurrentChartResizeXy[2] + col - MBLsheetCurrentChartResizeXy[6];
    ...
    if (
      ...
      if (
        MBLsheetCurrentChartResizeXy[1] + MBLsheetCurrentChartResizeXy[3] <
        row_pre
      ) {
        return;
      }
      ...
      top = row_pre;
      height = MBLsheetCurrentChartResizeXy[3] - topchange;

      if (
        top >
        MBLsheetCurrentChartResizeXy[3] +
          MBLsheetCurrentChartResizeXy[5] -
          row +
          row_pre
      ) {
        top =
        ...
        height =
          ...
          (MBLsheetCurrentChartResizeXy[3] +
            ...
            row +
            row_pre -
            MBLsheetCurrentChartResizeXy[1]);
      } else if (top <= 0) {
        top = 0;
        height =
          MBLsheetCurrentChartResizeXy[3] + MBLsheetCurrentChartResizeXy[1];
      }
    }
    ...
    if (
      ...
      if (
        MBLsheetCurrentChartResizeXy[7] - MBLsheetCurrentChartResizeXy[3] >
        row
      ) {
        return;
      }
      ...
      height =
        MBLsheetCurrentChartResizeXy[3] + row - MBLsheetCurrentChartResizeXy[7];
    ...
    let $span = _this.rangeResizeTo
      ...
      .html(rangetxt);
    MBLsheetRangeLast(_this.rangeResizeTo[0]);
    MBLsheetCurrentChartResizeObj.css(selected).data("range", range);
  },
  ...
  rangeResizeDragged: function (
    ...
    $("#MBLsheet-formula-functionrange-highlight-" + _this.rangeResizeIndex)
      .find(".MBLsheet-selection-copy-hc")
      .css("opacity", 0.03);
  },
  rangeMovexy: null,
  ...
  rangeMoveDraging: function (
    ...
    let row_index_original = MBLsheet_cell_selected_move_index[0],
      col_index_original = MBLsheet_cell_selected_move_index[1];
    let row_s =
        MBLsheet_select_save["row"][0] - row_index_original + rowLocation(y)[2],
      row_e =
        MBLsheet_select_save["row"][1] - row_index_original + rowLocation(y)[2];
    let col_s =
    ...
    if (row_s < 0 || y < 0) {
      row_s = 0;
      row_e = MBLsheet_select_save["row"][1] - MBLsheet_select_save["row"][0];
    }
    if (col_s < 0 || x < 0) {
      col_s = 0;
      col_e =
        MBLsheet_select_save["column"][1] - MBLsheet_select_save["column"][0];
    }
  ...
  rangeMoveDragged: function (obj) {
    ...
    $("#MBLsheet-formula-functionrange-highlight-" + _this.rangeMoveIndex)
  ...
  setCaretPosition: function (textDom, children, pos) {
    try {
      ...
      MBLsheetRangeLast(this.rangeResizeTo[0]);
    }
  },
      ...
      if (
        ...
        if (window.getSelection) {
          ...
          if ($(currSelection.anchorNode).is("div")) {
            let editorlen = $("#MBLsheet-rich-text-editor span").length;
        ...
        //     if(c.id=="MBLsheet-rich-text-editor" || $(c).closest("#MBLsheet-rich-text-editor")){
        //         $functionbox.html(value);
        //     }
        //     else if(c.id=="MBLsheet-functionbox-cell" || $(c).closest("#MBLsheet-functionbox-cell")){
        ...
        if ($copy.attr("id") == "MBLsheet-rich-text-editor") {
  ...
  functionHTML: function (txt) {
    ...
    while (i < funcstack.length) {
      ...
      if (
        ...
        if (str.length > 0) {
          function_str +=
            '<span dir="auto" class="MBLsheet-formula-text-func">' +
            str +
            '</span><span dir="auto" class="MBLsheet-formula-text-lpar">(</span>';
        } else {
          function_str +=
            '<span dir="auto" class="MBLsheet-formula-text-lpar">(</span>';
        }
        ...
        function_str +=
          ...
          '<span dir="auto" class="MBLsheet-formula-text-rpar">)</span>';
        str = "";
      } else if (
        s == "{" &&
        matchConfig.squote == 0 &&
        ...
        if (matchConfig.dquote > 0) {
          ...
          if (str.length > 0) {
            function_str +=
              _this.functionHTML(str) +
              '<span dir="auto" class="MBLsheet-formula-text-string">"';
          } else {
            function_str +=
              '<span dir="auto" class="MBLsheet-formula-text-string">"';
          }
      ...
      //修正例如输入公式='1-2'!A1时，只有2'!A1是MBLsheet-formula-functionrange-cell色，'1-是黑色的问题。
      else if (s == "'" && matchConfig.dquote == 0) {
        str += "'";
        ...
        function_str +=
          _this.functionHTML(str) +
          '<span dir="auto" class="MBLsheet-formula-text-comma">,</span>';
        str = "";
      } else if (
        s == "&" &&
        matchConfig.squote == 0 &&
        ...
        if (str.length > 0) {
          function_str +=
            _this.functionHTML(str) +
            '<span dir="auto" class="MBLsheet-formula-text-calc">' +
            "&" +
            "</span>";
          str = "";
        } else {
      ...
      if (i == funcstack.length - 1) {
        ...
        if (_this.iscelldata($.trim(str))) {
          ...
          if (regx.test($.trim(str))) {
            ...
            if (arraystart > 0) {
              alltxt +=
                '<span dir="auto" class="MBLsheet-formula-text-color">' +
                str.substr(0, arraystart) +
                "</span>";
            }

            alltxt +=
              '<span dir="auto" style="color:#959a05" class="MBLsheet-formula-text-array">' +
              arraytxt +
              "</span>";
  ...
  calPostfixExpression: function (cal) {
    ...
    for (let i = cal.length - 1; i >= 0; i--) {
      ...
      if (c in this.operatorjson) {
        ...
        let str = "MBLsheet_compareWith(" + s1 + ",'" + c + "', " + s2 + ")";
    ...
    while (i < funcstack.length) {
      ...
      if (
        ...
        if (str.length > 0 && bracket.length == 0) {
          ...
          if (str.indexOf(":") > -1) {
            ...
            function_str +=
              "MBLsheet_getSpecialReference(true,'" +
              $.trim(funcArray[0]).replace(/'/g, "\\'") +
              "', MBLsheet_function." +
              funcArray[1] +
              ".f(#lucky#";
          } else {
            function_str += "MBLsheet_function." + str + ".f(";
          }
          bracket.push(1);
          str = "";
        } else if (bracket.length == 0) {
      ...
      if (i == funcstack.length - 1) {
        ...
        if (_this.iscelldata(str_nb) && str_nb.substr(0, 1) != ":") {
          endstr = "MBLsheet_getcelldata('" + str_nb + "')";
          ...
          if (_this.iscelldata(str_nb)) {
            endstr =
              "MBLsheet_getSpecialReference(false," +
              function_str +
              ",'" +
              str_nb +
              "')";
          ...
          if (
            ...
            endstr += "MBLsheet_getarraydata('" + arraytxt + "')";
  ...
  insertUpdateDynamicArray: function (dynamicArrayItem) {
    ...
    let MBLsheetfile = get_MBLsheetfile();
    let file = MBLsheetfile[getSheetIndex(index)];
  ...
  addFunctionGroup: function (r, c, func, index) {
    ...
    setMBLsheetfile(MBLsheetfile);
  },
  getAllFunctionGroup: function () {
    let MBLsheetfile = get_MBLsheetfile();
    let ret = [];
    for (let i = 0; i < MBLsheetfile.length; i++) {
      let file = MBLsheetfile[i];
  ...
  isFunctionRangeSimple1: function (txt, r, c, index, dynamicArray_compute) {
    ...
    while (i < funcstack.length) {
      ...
      if (s == "(" && matchConfig.dquote == 0) {
        ...
        if (str.length > 0) {
          function_str += "MBLsheet_function." + str.toUpperCase() + ".f(";
        } else {
          function_str += "(";
        }
  ...
  isFunctionRange: function (
    ...
    // let MBLsheetfile = get_MBLsheetfile();
    // let dynamicArray_compute = MBLsheetfile[getSheetIndex(Store.currentSheetIndex)]["dynamicArray_compute"] == null ? {} : MBLsheetfile[getSheetIndex(Store.currentSheetIndex)]["dynamicArray_compute"];
    ...
    while (i < funcstack.length) {
      ...
      if (i == funcstack.length - 1) {
        ...
        let str_nb = $.trim(str).replace(/'/g, "\\'");
        if (_this.iscelldata(str_nb) && str_nb.substr(0, 1) != ":") {
          // endstr = "MBLsheet_getcelldata('" + $.trim(str) + "')";
          endstr = "MBLsheet_getcelldata('" + str_nb + "')";
          _this.isFunctionRangeSaveChange(
            str,
            r,
  ...
  checkSpecialFunctionRange: function (
    ...
    if (
      function_str.substr(0, 30) == "MBLsheet_getSpecialReference" ||
      function_str.substr(0, 20) == "MBLsheet_function."
    ) {
      if (function_str.substr(0, 20) == "MBLsheet_function.") {
    ...
    //             let tempFunc = "MBLsheet_indirect_check" + function_str.substr(30, function_str.length);

    //             //tempFunc = tempFunc.replace(/MBLsheet_getcelldata/g, "MBLsheet_indirect_check_return");
    ...
    //             let tempFunc = "MBLsheet_offset_check" + function_str.substr(28, function_str.length);
  ...
  execFunctionGroup: function (
    ...
    if (!window.MBLsheet_compareWith) {
      window.MBLsheet_compareWith = MBLsheet_compareWith;
      window.MBLsheet_getarraydata = MBLsheet_getarraydata;
      window.MBLsheet_getcelldata = MBLsheet_getcelldata;
      window.MBLsheet_parseData = MBLsheet_parseData;
      window.MBLsheet_getValue = MBLsheet_getValue;
      window.MBLsheet_indirect_check = MBLsheet_indirect_check;
      window.MBLsheet_indirect_check_return = MBLsheet_indirect_check_return;
      window.MBLsheet_offset_check = MBLsheet_offset_check;
      window.MBLsheet_calcADPMM = MBLsheet_calcADPMM;
      window.MBLsheet_getSpecialReference = MBLsheet_getSpecialReference;
    }
  ...
  execFunctionGroup1: function (
    ...
    let dynamicArray_compute =
      MBLsheetfile[getSheetIndex(Store.currentSheetIndex)][
        "dynamicArray_compute"
      ] == null
        ? {}
        : MBLsheetfile[getSheetIndex(Store.currentSheetIndex)][
    ...
    if (_this.execFunctionExist == null) {
      for (let i = 0; i < group.length; i++) {
        let item = group[i];
        let file = MBLsheetfile[getSheetIndex(item["index"])];
        if (file == null) {
          continue;
        }
  ...
  functionDFS: function (u) {
    ...
    //         window.MBLsheetCurrentRow = u.r;
    //         window.MBLsheetCurrentColumn = u.c;
    //         window.MBLsheetCurrentIndex = u.index;
    //         window.MBLsheetCurrentFunction = calc_funcStr;
  ...
  execfunction: function (txt, r, c, index, isrefresh, notInsertFunc) {
    ...
    //console.log(fp)
    if (
      fp.substr(0, 20) == "MBLsheet_function." ||
      fp.substr(0, 22) == "MBLsheet_compareWith"
    ) {
      _this.functionHTMLIndex = 0;
    }
    ...
    window.MBLsheetCurrentIndex = index;
    window.MBLsheetCurrentFunction = txt;

    let sparklines = null;

    try {
      if (fp.indexOf("MBLsheet_getcelldata") > -1) {
        let funcg = fp.split("MBLsheet_getcelldata('");
    ...
    window.MBLsheetCurrentRow = null;
    window.MBLsheetCurrentColumn = null;
    window.MBLsheetCurrentIndex = null;
    window.MBLsheetCurrentFunction = null;
...
export default MBLsheetformula;
