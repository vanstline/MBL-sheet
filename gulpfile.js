 ...
 * ${pkg.name}
 * version: ${pkg.version}
 * https://github.com/vanstline/MBLsheet
 */`;
...
// proxy middleware
const apiProxy = createProxyMiddleware("/MBLsheet/", {
